...
*
*/
public abstract class S6aAnswerImpl extends VendorSpecificAnswerImpl implements S6aAnswer
{
	protected DRMP drmp;
	...
	protected S6aAnswerImpl() 
	{
		super();
	}
	
	public S6aAnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
