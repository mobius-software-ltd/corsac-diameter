...
*
*/
@DiameterAvpImplementation(code = 1504L, vendorId = KnownVendorIDs.TGPP_ID)
public class ANIDImpl extends DiameterUTF8StringImpl implements ANID
{
	protected ANIDImpl()
	{
		super();
	...
	protected ANIDImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public ANIDImpl(String value, Integer minLength, Integer maxLength)
	{
