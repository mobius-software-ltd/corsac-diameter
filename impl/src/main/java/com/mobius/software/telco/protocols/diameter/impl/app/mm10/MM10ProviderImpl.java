...
*
*/
public class MM10ProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(MM10ProviderImpl.class);
	
	public MM10ProviderImpl(DiameterStack stack,String packageName)
	{
