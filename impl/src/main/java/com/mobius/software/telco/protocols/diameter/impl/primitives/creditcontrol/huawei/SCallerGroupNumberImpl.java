...
*
*/
@DiameterAvpImplementation(code = 21205L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCallerGroupNumberImpl extends DiameterOctetStringImpl implements SCallerGroupNumber
{
	protected SCallerGroupNumberImpl()
	{
		super(0, 32);
	}

	public SCallerGroupNumberImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}