...
*
*/
@DiameterAvpImplementation(code = 30318L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ExParameter7Impl extends DiameterUTF8StringImpl implements ExParameter7
{
	protected ExParameter7Impl()
	{
		super(0, 256);
	}

	public ExParameter7Impl(String value)
	{
		super(value, 0, 256);
	}
}