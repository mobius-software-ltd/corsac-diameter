...
*
*/
@DiameterAvpImplementation(code = 3105L, vendorId = KnownVendorIDs.TGPP_ID)
public class ServiceParametersImpl extends DiameterGroupedAvpImpl implements ServiceParameters
{
	private T4Parameters t4Parameters;
	
	private ApplicationPortIdentifier applicationPortIdentifier;
	
	public ServiceParametersImpl()
	{
	...
	{
		return this.t4Parameters;
	}
	
	public void setT4Parameters(T4Parameters value)
	{
		this.t4Parameters = value;
	}
