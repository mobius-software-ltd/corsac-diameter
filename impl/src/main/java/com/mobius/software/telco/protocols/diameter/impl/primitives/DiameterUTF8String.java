...
public class DiameterUTF8String extends DiameterOctetString
{
	public static final Charset ENCODING=Charset.forName("UTF-8");
	private String value;
	
	//required for parser
	public DiameterUTF8String() 
	{
		super();
	}
	
	public DiameterUTF8String(Integer minLength,Integer maxLength) 
	{
		super(minLength,maxLength);		
	}
	
	public DiameterUTF8String(String value,Integer minLength,Integer maxLength) 
	{
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterUTF8String other = (DiameterUTF8String) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
