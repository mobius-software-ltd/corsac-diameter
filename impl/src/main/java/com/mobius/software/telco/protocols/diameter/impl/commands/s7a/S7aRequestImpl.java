...
*
*/
public abstract class S7aRequestImpl extends VendorSpecificRequestmpl implements S7aRequest
{
	private DRMP drmp;
	...
	public S7aRequestImpl(String originHost,String originRealm,String destinationHost,String destinationRealm,Boolean isRetransmit, String sessonID, AuthSessionStateEnum authSessionState)
	{
