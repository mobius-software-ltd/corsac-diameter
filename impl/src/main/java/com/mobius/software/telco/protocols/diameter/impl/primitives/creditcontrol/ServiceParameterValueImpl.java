...
public class ServiceParameterValueImpl extends DiameterOctetStringImpl implements ServiceParameterValue
{
	...
	protected ServiceParameterValueImpl(Integer minLength,Integer maxLength) 
	{
		super(minLength, maxLength);
	}
	
	public ServiceParameterValueImpl(ByteBuf value,Integer minLength,Integer maxLength) 
	{
