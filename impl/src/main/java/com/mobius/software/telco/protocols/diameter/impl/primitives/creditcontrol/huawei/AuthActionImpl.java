...
*
*/
@DiameterAvpImplementation(code = 30803L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class AuthActionImpl extends DiameterUTF8StringImpl implements AuthAction
{
	protected AuthActionImpl()
	{
		super(0,36);
	}

	public AuthActionImpl(String value)
	{
		super(value, 0, 36);
	}
}