...
public class DiameterFloat32 
{
	...
	//required for parser
	public DiameterFloat32() 
	{
		
	}
	
	public DiameterFloat32(Float minValue,Float maxValue) 
	{
		this.minValue = minValue;
		this.maxValue = maxValue;
	}
	
	public DiameterFloat32(Float value,Float minValue,Float maxValue) 
	{
		this.value=value;
		this.minValue = minValue;
		this.maxValue = maxValue;
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterFloat32 other = (DiameterFloat32) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
