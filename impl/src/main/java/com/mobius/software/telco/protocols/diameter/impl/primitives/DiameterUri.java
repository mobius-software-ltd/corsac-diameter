...
public class DiameterUri extends DiameterAsciiString
{
	private String host;
	...
	public DiameterUri(Integer minLength,Integer maxLength) 
	{
		super(minLength,maxLength);		
	}
		
	public DiameterUri(String uri,Integer minLength,Integer maxLength) throws ParseException 
	{
		super(uri,minLength,maxLength);	
		parseUri();
	}
	
	public DiameterUri(String host,Integer port,Boolean isSecure,DiameterTransport transport, DiameterProtocol protocol,Integer minLength,Integer maxLength)
	{
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterUri other = (DiameterUri) obj;
		if (getUri() == null) 
		{
