...
*
*/
@DiameterAvpImplementation(code = 3836L, vendorId = KnownVendorIDs.TGPP_ID)
public class MICImpl extends DiameterOctetStringImpl implements MIC
{
	protected MICImpl()
	{
		super();
	...
	protected MICImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public MICImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
