...
*
*/
@DiameterAvpImplementation(code = 619L, vendorId = -1L)
public class ERPRealmImpl extends DiameterIdentityImpl implements ERPRealm
{
	protected ERPRealmImpl()
	{
		super();
	}

	protected ERPRealmImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public ERPRealmImpl(String value, Integer minLength, Integer maxLength)
	{
