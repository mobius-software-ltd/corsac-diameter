...
public class MediaAuthorizationContextIdImpl extends DiameterUTF8StringImpl implements MediaAuthorizationContextId
{
	...
	protected MediaAuthorizationContextIdImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public MediaAuthorizationContextIdImpl(String value, Integer minLength, Integer maxLength)
	{
