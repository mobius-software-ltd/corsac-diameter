...
*
*/
@DiameterCommandImplementation(applicationId = 6, commandCode = 288, request = false)
public class PushProfileAnswerImpl extends AuthenticationAnswerImpl implements PushProfileAnswer
{
	...
	public PushProfileAnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID, Long authApplicationId,AuthSessionStateEnum authSessionState)
	{
