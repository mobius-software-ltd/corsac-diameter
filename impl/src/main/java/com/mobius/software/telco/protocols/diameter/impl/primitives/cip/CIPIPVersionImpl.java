...
public class CIPIPVersionImpl extends DiameterUTF8StringImpl implements CIPIPVersion
{
	protected CIPIPVersionImpl()
	{
		super();
	}

	protected CIPIPVersionImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}
	
	public CIPIPVersionImpl(String value, Integer minLength, Integer maxLength)
	{
