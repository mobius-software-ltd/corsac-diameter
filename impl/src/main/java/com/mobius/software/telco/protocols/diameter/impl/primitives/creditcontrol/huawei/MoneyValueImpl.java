...
*
*/
@DiameterAvpImplementation(code = 20328L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class MoneyValueImpl extends DiameterInteger64Impl implements MoneyValue
{
	...
	protected MoneyValueImpl(Long minValue, Long maxValue)
	{
		super(minValue, maxValue);
	}

	public MoneyValueImpl(Long value, Long minValue, Long maxValue)
	{
