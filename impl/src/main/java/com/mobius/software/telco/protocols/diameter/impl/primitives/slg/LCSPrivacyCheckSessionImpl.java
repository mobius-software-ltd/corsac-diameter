...
*
*/
@DiameterAvpImplementation(code = 2522L, vendorId = KnownVendorIDs.TGPP_ID)
public class LCSPrivacyCheckSessionImpl implements LCSPrivacyCheckSession
{
	private LCSPrivacyCheck lcsPrivacyCheck;
	
	protected LCSPrivacyCheckSessionImpl() 
	{
	}
	
	public LCSPrivacyCheckSessionImpl(LCSPrivacyCheckEnum lcsPrivacyCheck)
	{
