...
*
*/
@DiameterAvpImplementation(code = 20407L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class DestAddressImpl extends DiameterUTF8StringImpl implements DestAddress
{
	protected DestAddressImpl()
	{
		super(0, 63);
	}

	public DestAddressImpl(String value)
	{
		super(value, 0, 63);
	}
}