...
*
*/
public class SgdProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(SgdProviderImpl.class);
	
	public SgdProviderImpl(DiameterStack stack,String packageName)
	{
	...
	{		
		try
		{
			if(message instanceof SgdRequest)
				return new SgdServerSessionImpl(message.getSessionId(), message.getOriginHost(), message.getOriginRealm(), this);
		}
