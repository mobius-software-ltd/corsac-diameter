...
*
*/
@DiameterAvpImplementation(code = 108L, vendorId = -1)
public class DigestMethodImpl extends DiameterUTF8StringImpl implements DigestMethod
{
	...
	protected DigestMethodImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public DigestMethodImpl(String value, Integer minLength, Integer maxLength)
	{
