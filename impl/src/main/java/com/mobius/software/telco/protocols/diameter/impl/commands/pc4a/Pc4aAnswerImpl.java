...
*
*/
public abstract class Pc4aAnswerImpl extends VendorSpecificAnswerImpl implements Pc4aAnswer
{
	...
	protected Pc4aAnswerImpl() 
	{
		super();
	}
	
	public Pc4aAnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
