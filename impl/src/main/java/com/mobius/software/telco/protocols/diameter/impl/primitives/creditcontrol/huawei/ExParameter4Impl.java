...
*
*/
@DiameterAvpImplementation(code = 30315L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ExParameter4Impl extends DiameterUTF8StringImpl implements ExParameter4
{
	protected ExParameter4Impl()
	{
		super(0, 256);
	}

	public ExParameter4Impl(String value)
	{
		super(value, 0, 256);
	}
}