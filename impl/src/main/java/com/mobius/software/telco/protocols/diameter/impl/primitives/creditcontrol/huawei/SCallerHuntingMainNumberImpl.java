...
*
*/
@DiameterAvpImplementation(code = 21211L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCallerHuntingMainNumberImpl extends DiameterOctetStringImpl implements SCallerHuntingMainNumber
{
	protected SCallerHuntingMainNumberImpl()
	{
		super(0, 32);
	}

	public SCallerHuntingMainNumberImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}