...
public class SessionFactoryImpl implements SessionFactory
{
	...
	@Override
	public SlhClientSession createClientSession(LCSRoutingInfoRequest request) throws AvpNotSupportedException
	{
		return new SlhClientSessionImpl(request.getSessionId(), request.getDestinationHost(), request.getDestinationRealm(), provider);
	}

	@Override
	public SlhServerSession createServerSession(LCSRoutingInfoRequest request) throws AvpNotSupportedException
	{
		return new SlhServerSessionImpl(request.getSessionId(), request.getOriginHost(), request.getOriginRealm(), provider);
	}
