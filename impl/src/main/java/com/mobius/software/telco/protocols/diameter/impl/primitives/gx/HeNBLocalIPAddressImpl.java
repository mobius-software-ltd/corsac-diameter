...
public class HeNBLocalIPAddressImpl extends DiameterAddressImpl implements HeNBLocalIPAddress
{
	...
	protected HeNBLocalIPAddressImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public HeNBLocalIPAddressImpl(InetAddress value, Integer minLength, Integer maxLength)
	{
