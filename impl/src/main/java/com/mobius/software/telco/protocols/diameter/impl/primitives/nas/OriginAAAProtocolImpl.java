...
public class OriginAAAProtocolImpl extends DiameterEnumeratedImpl<OriginAAAProtocolEnum> implements OriginAAAProtocol
{
	...
	protected OriginAAAProtocolImpl(Integer minValue,Integer maxValue) 
	{
		super(minValue, maxValue);
	}
	
	public OriginAAAProtocolImpl(OriginAAAProtocolEnum value,Integer minValue,Integer maxValue) 
	{
