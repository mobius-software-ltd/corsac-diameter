...
*
*/
@DiameterAvpImplementation(code = 3319L, vendorId = KnownVendorIDs.TGPP_ID)
public class SGSNSMDeliveryOutcomeImpl implements SGSNSMDeliveryOutcome
{
	private SMDeliveryCause smDeliveryCause;
	
	private AbsentUserDiagnosticSM absentUserDiagnosticSM;
	
	public SGSNSMDeliveryOutcomeImpl()
	{
