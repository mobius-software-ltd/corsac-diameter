...
*
*/
@DiameterAvpImplementation(code = 3163L, vendorId = KnownVendorIDs.TGPP_ID)
public class GroupReportingGuardTimerImpl extends DiameterUnsigned32Impl implements GroupReportingGuardTimer
{
	...
	protected GroupReportingGuardTimerImpl(Long minValue, Long maxValue)
	{
		super(minValue, maxValue);
	}

	public GroupReportingGuardTimerImpl(Long value, Long minValue, Long maxValue)
	{
