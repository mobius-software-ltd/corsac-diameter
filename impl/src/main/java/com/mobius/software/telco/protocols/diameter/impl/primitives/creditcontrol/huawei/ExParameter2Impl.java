...
*
*/
@DiameterAvpImplementation(code = 30313L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ExParameter2Impl extends DiameterUTF8StringImpl implements ExParameter2
{

	protected ExParameter2Impl()
	{
		super(0, 256);
	}

	public ExParameter2Impl(String value)
	{
		super(value, 0, 256);
	}
}