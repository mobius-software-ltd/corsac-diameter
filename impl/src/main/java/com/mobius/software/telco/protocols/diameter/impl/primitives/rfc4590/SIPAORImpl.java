...
*
*/
@DiameterAvpImplementation(code = 122L, vendorId = -1)
public class SIPAORImpl extends DiameterUTF8StringImpl implements SIPAOR
{
	protected SIPAORImpl()
	{
		super();
	}

	protected SIPAORImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public SIPAORImpl(String value, Integer minLength, Integer maxLength)
	{
