...
*
*/
@DiameterAvpImplementation(code = 2517L, vendorId = KnownVendorIDs.TGPP_ID)
public class ECGIImpl extends DiameterOctetStringImpl implements ECGI
{
	protected ECGIImpl()
	{
		super();
	...
	protected ECGIImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public ECGIImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
