...
*
*/
@DiameterAvpImplementation(code = 3512L, vendorId = KnownVendorIDs.TGPP_ID)
public class TMGIDeallocationRequestImpl extends DiameterGroupedAvpImpl implements TMGIDeallocationRequest
{
	private List<TMGI> tmgi;
	
	public TMGIDeallocationRequestImpl()
	{
