...
*
*/
public abstract class SlgRequestImpl extends VendorSpecificRequestImpl implements SlgRequest
{
	protected DRMP drmp;
	...
	protected SlgRequestImpl() 
	{
		super();
	}
		
	public SlgRequestImpl(String originHost,String originRealm,String destinationHost,String destinationRealm,Boolean isRetransmit, String sessonID, AuthSessionStateEnum authSessionState) throws AvpNotSupportedException, MissingAvpException
	{
