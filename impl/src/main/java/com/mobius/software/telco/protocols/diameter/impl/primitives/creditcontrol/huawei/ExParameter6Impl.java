...
*
*/
@DiameterAvpImplementation(code = 30317L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ExParameter6Impl extends DiameterUTF8StringImpl implements ExParameter6
{
	protected ExParameter6Impl()
	{
		super(0, 256);
	}

	public ExParameter6Impl(String value)
	{
		super(value, 0, 256);
	}
}