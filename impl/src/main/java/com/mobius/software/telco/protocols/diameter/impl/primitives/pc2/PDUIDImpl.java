...
*
*/
@DiameterAvpImplementation(code = 3604L, vendorId = KnownVendorIDs.TGPP_ID)
public class PDUIDImpl extends DiameterOctetStringImpl implements PDUID
{
	protected PDUIDImpl()
	{
		super();
	...
	protected PDUIDImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public PDUIDImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
