...
*
*/
@DiameterAvpImplementation(code = 20637L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CDRSPNameImpl extends DiameterUTF8StringImpl implements CDRSPName
{
	protected CDRSPNameImpl()
	{
		super(0, 256);
	}

	public CDRSPNameImpl(String value)
	{
		super(value, 0, 256);
	}
}