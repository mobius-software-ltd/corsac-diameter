...
*
*/
@DiameterCommandImplementation(applicationId = 16777264, commandCode = 258, request = false)
public class ReAuthAnswerImpl extends SwmAnswerImpl implements ReAuthAnswer
{
