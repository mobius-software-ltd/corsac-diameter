...
*
*/
@DiameterAvpImplementation(code = 20636L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CDRPkgProductIdImpl extends DiameterUTF8StringImpl implements CDRPkgProductId
{
	protected CDRPkgProductIdImpl()
	{
		super(0, 32);
	}

	public CDRPkgProductIdImpl(String value)
	{
		super(value, 0, 32);
	}
}