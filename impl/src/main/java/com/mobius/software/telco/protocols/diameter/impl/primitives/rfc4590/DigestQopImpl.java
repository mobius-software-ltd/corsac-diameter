...
*
*/
@DiameterAvpImplementation(code = 110L, vendorId = -1)
public class DigestQopImpl extends DiameterUTF8StringImpl implements DigestQop
{
	protected DigestQopImpl()
	{
		super();
	}

	protected DigestQopImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public DigestQopImpl(String value, Integer minLength, Integer maxLength)
	{
