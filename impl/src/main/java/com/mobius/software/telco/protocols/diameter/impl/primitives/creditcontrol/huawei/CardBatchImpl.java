...
*
*/
@DiameterAvpImplementation(code = 20364L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CardBatchImpl extends DiameterOctetStringImpl implements CardBatch
{
	protected CardBatchImpl()
	{
		super(0, 32);
	}

	public CardBatchImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}