...
public class AggregatedRUCIReportServerSessionImpl extends ServerAuthSessionStatelessImpl<AggregatedRUCIReportRequest, AggregatedRUCIReportAnswer> implements AggregatedRUCIReportServerSession
{
	public AggregatedRUCIReportServerSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<?, ? extends ServerAuthStatelessListener, ?, ?, ?> provider)
	{
