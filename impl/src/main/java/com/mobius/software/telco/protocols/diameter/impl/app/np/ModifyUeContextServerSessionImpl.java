...
public class ModifyUeContextServerSessionImpl extends ServerAuthSessionStatelessImpl<ModifyUeContextRequest, ModifyUeContextAnswer> implements ModifyUeContextServerSession
{
	public ModifyUeContextServerSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<?, ? extends ServerAuthStatelessListener, ?, ?, ?> provider)
	{
