...
*
*/
@DiameterAvpImplementation(code = 3336L, vendorId = KnownVendorIDs.TGPP_ID)
public class SMSF3GPPSMDeliveryOutcomeImpl implements SMSF3GPPSMDeliveryOutcome
{
	private SMDeliveryCause smDeliveryCause;
	
	private AbsentUserDiagnosticSM absentUserDiagnosticSM;
	
	public SMSF3GPPSMDeliveryOutcomeImpl()
	{
