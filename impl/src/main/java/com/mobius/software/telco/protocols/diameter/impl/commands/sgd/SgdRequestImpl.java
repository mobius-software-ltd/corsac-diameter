...
*
*/
public abstract class SgdRequestImpl extends VendorSpecificRequestImpl implements SgdRequest
{
	protected DRMP drmp;
	...
	protected SgdRequestImpl() 
	{
		super();
	}
		
	public SgdRequestImpl(String originHost,String originRealm,String destinationHost,String destinationRealm,Boolean isRetransmit, String sessonID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
