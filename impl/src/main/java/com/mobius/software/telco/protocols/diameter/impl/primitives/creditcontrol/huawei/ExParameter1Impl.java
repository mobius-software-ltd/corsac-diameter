...
*
*/
@DiameterAvpImplementation(code = 30312L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ExParameter1Impl extends DiameterUTF8StringImpl implements ExParameter1
{

	protected ExParameter1Impl()
	{
		super(0, 256);
	}

	public ExParameter1Impl(String value)
	{
		super(value, 0, 256);
	}
}