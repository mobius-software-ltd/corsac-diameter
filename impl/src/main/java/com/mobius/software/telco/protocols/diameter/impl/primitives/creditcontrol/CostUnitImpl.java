...
*
*/
@DiameterAvpImplementation(code = 424L, vendorId = -1L)
public class CostUnitImpl extends DiameterUTF8StringImpl implements CostUnit
{
	...
	protected CostUnitImpl(Integer minLength,Integer maxLength) 
	{
		super(minLength,maxLength);		
	}
	
	public CostUnitImpl(String value,Integer minLength,Integer maxLength) 
	{
