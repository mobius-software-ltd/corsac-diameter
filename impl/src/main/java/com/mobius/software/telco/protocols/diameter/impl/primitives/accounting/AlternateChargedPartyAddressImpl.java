...
public class AlternateChargedPartyAddressImpl extends DiameterUTF8StringImpl implements AlternateChargedPartyAddress
{
	...
	protected AlternateChargedPartyAddressImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public AlternateChargedPartyAddressImpl(String value, Integer minLength, Integer maxLength)
	{
