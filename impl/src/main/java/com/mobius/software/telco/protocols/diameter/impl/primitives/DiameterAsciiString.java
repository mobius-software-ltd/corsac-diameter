...
public class DiameterAsciiString extends DiameterOctetString
{
	public static final Charset ENCODING=Charset.forName("iso-8859-1");
	private String value;
	
	//required for parser
	public DiameterAsciiString() 
	{
		super();
	}
		
	public DiameterAsciiString(Integer minLength,Integer maxLength) 
	{
		super(minLength,maxLength);		
	}
		
	public DiameterAsciiString(String value,Integer minLength,Integer maxLength) 
	{
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterAsciiString other = (DiameterAsciiString) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
