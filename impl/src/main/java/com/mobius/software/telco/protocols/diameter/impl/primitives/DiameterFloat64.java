...
public class DiameterFloat64 
{
	...
	//required for parser
	public DiameterFloat64() 
	{
		
	}
	
	public DiameterFloat64(Double minValue,Double maxValue) 
	{
		this.minValue = minValue;
		this.maxValue = maxValue;
	}
	
	public DiameterFloat64(Double value,Double minValue,Double maxValue) 
	{
		this.value=value;
		this.minValue = minValue;
		this.maxValue = maxValue;
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterFloat64 other = (DiameterFloat64) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
