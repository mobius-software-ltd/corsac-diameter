...
public class EricssonProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public EricssonProviderImpl(DiameterStack stack)
	{
	...
	{		
		try
		{
			if(message instanceof CreditControlRequest)
				return new EricssonServerSessionImpl(message.getSessionId(), message.getOriginHost(), message.getOriginRealm(), this);
		}
