...
import com.mobius.software.telco.protocols.diameter.commands.swd.SwdRequest;
...
*
*/
public abstract class SwdRequestImpl extends AuthenticationRequestWithHostBase implements SwdRequest
{
	private DRMP drmp;
	...
	public SwdRequestImpl(String originHost,String originRealm, String destinationHost, String destinationRealm, Boolean isRetransmit, String sessonID, Long authApplicationId)
	{
