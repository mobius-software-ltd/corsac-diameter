...
*
*/
@DiameterAvpImplementation(code = 20435L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class DestIMSIImpl extends DiameterUTF8StringImpl implements DestIMSI
{
	protected DestIMSIImpl()
	{
		super(0, 20);
	}

	public DestIMSIImpl(String value)
	{
		super(value, 0, 20);
	}
}