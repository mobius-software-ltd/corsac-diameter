...
*
*/
@DiameterAvpImplementation(code = 2062L, vendorId = KnownVendorIDs.TGPP_ID)
public class IncrementalCostImpl implements IncrementalCost
{
	private ValueDigits valueDigits;
	private Exponent exponent;
	
	protected IncrementalCostImpl()
	{
	}
	
	public IncrementalCostImpl(Long valueDigits)
	{
		if(valueDigits==null)
