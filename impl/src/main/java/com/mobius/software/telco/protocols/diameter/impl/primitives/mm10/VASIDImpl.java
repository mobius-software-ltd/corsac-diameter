...
*
*/
@DiameterAvpImplementation(code = 1102L, vendorId = -1L)
public class VASIDImpl extends DiameterUTF8StringImpl implements VASID
{
	protected VASIDImpl()
	{
		super();
	...
	protected VASIDImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public VASIDImpl(String value, Integer minLength, Integer maxLength)
	{
