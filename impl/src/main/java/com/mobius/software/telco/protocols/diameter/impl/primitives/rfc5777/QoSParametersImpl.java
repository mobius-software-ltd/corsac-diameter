...
@DiameterAvpImplementation(code = 576L, vendorId = -1L)
public class QoSParametersImpl extends DiameterGroupedAvpImpl implements QoSParameters
{
	public QoSParametersImpl()
	{
