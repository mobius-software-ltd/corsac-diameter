...
*
*/
@DiameterAvpImplementation(code = 20643L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class TransactionIdImpl extends DiameterUTF8StringImpl implements TransactionId
{
	protected TransactionIdImpl()
	{
		super(0, 30);
	}

	public TransactionIdImpl(String value)
	{
		super(value, 0, 30);
	}
}