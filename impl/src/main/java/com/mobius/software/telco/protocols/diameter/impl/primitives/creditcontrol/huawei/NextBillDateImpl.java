...
*
*/
@DiameterAvpImplementation(code = 21186L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class NextBillDateImpl extends DiameterOctetStringImpl implements NextBillDate
{
	protected NextBillDateImpl()
	{
		super(0, 20);
	}

	public NextBillDateImpl(ByteBuf value)
	{
		super(value, 0, 20);
	}
}