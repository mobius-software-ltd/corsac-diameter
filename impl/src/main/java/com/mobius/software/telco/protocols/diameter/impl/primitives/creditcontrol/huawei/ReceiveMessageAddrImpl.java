...
*
*/
@DiameterAvpImplementation(code = 20732L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ReceiveMessageAddrImpl extends DiameterUTF8StringImpl implements ReceiveMessageAddr
{
	protected ReceiveMessageAddrImpl()
	{
		super(0, 36);
	}

	public ReceiveMessageAddrImpl(String value)
	{
		super(value, 0, 36);
	}
}