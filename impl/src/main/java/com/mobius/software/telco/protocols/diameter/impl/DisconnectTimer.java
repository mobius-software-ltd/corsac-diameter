...
*
*/
public class DisconnectTimer implements Timer 
{
	public static Logger logger=LogManager.getLogger(DisconnectTimer.class);
	...
	public DisconnectTimer(DiameterLink link)
	{
