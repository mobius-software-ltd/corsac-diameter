...
*
*/
@DiameterAvpImplementation(code = 3864L, vendorId = KnownVendorIDs.TGPP_ID)
public class DUCKImpl extends DiameterOctetStringImpl implements DUCK
{
	protected DUCKImpl()
	{
		super();
	...
	protected DUCKImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public DUCKImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
