...
*
*/
@DiameterAvpImplementation(code = 20326L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ChargeNumberImpl extends DiameterOctetStringImpl implements ChargeNumber
{
	protected ChargeNumberImpl()
	{
		super(0, 64);
	}

	public ChargeNumberImpl(ByteBuf value)
	{
		super(value, 0, 64);
	}
}