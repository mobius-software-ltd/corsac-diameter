...
*
*/
@DiameterAvpImplementation(code = 21206L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCallerTopGroupNumberImpl extends DiameterOctetStringImpl implements SCallerTopGroupNumber
{
	protected SCallerTopGroupNumberImpl()
	{
		super(0, 32);
	}

	public SCallerTopGroupNumberImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}