...
public class GCSNotificationClientSessionImpl extends ClientAuthSessionStatelessImpl<GCSNotificationRequest, GCSNotificationAnswer> implements GCSNotificationClientSession
{
	public GCSNotificationClientSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<? extends ClientAuthStatelessListener, ?, ?, ?, ?> provider)
	{
