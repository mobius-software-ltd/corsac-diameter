...
public class SIPSupportedUserDataTypeImpl extends DiameterUTF8StringImpl implements SIPSupportedUserDataType
{
	...
	protected SIPSupportedUserDataTypeImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public SIPSupportedUserDataTypeImpl(String value, Integer minLength, Integer maxLength)
	{
