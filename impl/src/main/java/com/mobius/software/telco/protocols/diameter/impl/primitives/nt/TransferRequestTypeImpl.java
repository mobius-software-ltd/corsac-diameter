...
public class TransferRequestTypeImpl extends DiameterEnumeratedImpl<TransferRequestTypeEnum> implements TransferRequestType
{
	...
	protected TransferRequestTypeImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}

	public TransferRequestTypeImpl(TransferRequestTypeEnum value, Integer minValue, Integer maxValue)
	{
