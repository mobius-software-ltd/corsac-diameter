...
*
*/
@DiameterAvpImplementation(code = 3325L, vendorId = KnownVendorIDs.TGPP_ID)
public class HSSIDImpl extends DiameterUTF8StringImpl implements HSSID
{
	protected HSSIDImpl()
	{
		super();
	...
	protected HSSIDImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public HSSIDImpl(String value, Integer minLength, Integer maxLength)
	{
