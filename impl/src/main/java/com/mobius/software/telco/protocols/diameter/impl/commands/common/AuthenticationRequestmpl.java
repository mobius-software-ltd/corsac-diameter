...
*
*/
public abstract class AuthenticationRequestmpl extends DiameterRequestWithSessionAndRealmBase implements AuthenticationRequest
{
	private AuthApplicationId authApplicationId;
	
	public List<RouteRecord> routeRecords;
	
	protected AuthenticationRequestmpl() 
	{
		super();
	}
		
	public AuthenticationRequestmpl(String originHost,String originRealm,String destinationHost,String destinationRealm,Boolean isRetransmit, String sessonID, Long authApplicationId)
	{
