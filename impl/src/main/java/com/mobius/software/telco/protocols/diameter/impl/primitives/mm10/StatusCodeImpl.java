...
*
*/
@DiameterAvpImplementation(code = 1117L, vendorId = -1L)
public class StatusCodeImpl extends DiameterUTF8StringImpl implements StatusCode
{
	...
	protected StatusCodeImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public StatusCodeImpl(String value, Integer minLength, Integer maxLength)
	{
