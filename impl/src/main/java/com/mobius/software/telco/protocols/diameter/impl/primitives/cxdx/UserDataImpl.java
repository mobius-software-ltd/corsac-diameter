...
*
*/
@DiameterAvpImplementation(code = 606L, vendorId = KnownVendorIDs.TGPP_ID)
public class UserDataImpl extends DiameterOctetStringImpl implements UserData
{
	...
	protected UserDataImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public UserDataImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
