...
public class NonAggregatedRUCIReportServerSessionImpl extends ServerAuthSessionStatelessImpl<NonAggregatedRUCIReportRequest, NonAggregatedRUCIReportAnswer> implements NonAggregatedRUCIReportServerSession
{
	public NonAggregatedRUCIReportServerSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<?, ? extends ServerAuthStatelessListener, ?, ?, ?> provider)
	{
