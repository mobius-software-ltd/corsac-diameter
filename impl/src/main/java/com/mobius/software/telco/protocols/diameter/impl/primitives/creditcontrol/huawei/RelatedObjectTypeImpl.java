...
*
*/
@DiameterAvpImplementation(code = 60008L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class RelatedObjectTypeImpl extends DiameterInteger32Impl implements RelatedObjectType
{
	...
	protected RelatedObjectTypeImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}

	public RelatedObjectTypeImpl(Integer value, Integer minValue, Integer maxValue)
	{
