...
*
*/
@DiameterAvpImplementation(code = 3004L, vendorId = KnownVendorIDs.TGPP_ID)
public class PayloadImpl extends DiameterOctetStringImpl implements Payload
{
	...
	protected PayloadImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public PayloadImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
