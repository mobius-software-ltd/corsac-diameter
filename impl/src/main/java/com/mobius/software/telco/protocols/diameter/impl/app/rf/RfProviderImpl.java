...
*
*/
public class RfProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(RfProviderImpl.class);
	
	public RfProviderImpl(DiameterStack stack,String packageName)
	{
