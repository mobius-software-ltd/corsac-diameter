...
*
*/
@DiameterAvpImplementation(code = 1101L, vendorId = -1L)
public class VASPIDImpl extends DiameterUTF8StringImpl implements VASPID
{
	protected VASPIDImpl()
	{
		super();
	}

	protected VASPIDImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public VASPIDImpl(String value, Integer minLength, Integer maxLength)
	{
