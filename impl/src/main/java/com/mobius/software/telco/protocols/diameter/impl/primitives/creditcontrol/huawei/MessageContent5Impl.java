...
*
*/
@DiameterAvpImplementation(code = 20700L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class MessageContent5Impl extends DiameterUTF8StringImpl implements MessageContent5
{
	protected MessageContent5Impl()
	{
		super(0, 256);
	}

	public MessageContent5Impl(String value)
	{
		super(value, 0, 256);
	}
}