...
public class ReportCardinalityImpl extends DiameterEnumeratedImpl<ReportCardinalityEnum> implements ReportCardinality
{
	...
	protected ReportCardinalityImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}

	public ReportCardinalityImpl(ReportCardinalityEnum value, Integer minValue, Integer maxValue)
	{
