...
*
*/
@DiameterAvpImplementation(code = 21181L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ValidityDate2Impl extends DiameterOctetStringImpl implements ValidityDate2
{
	protected ValidityDate2Impl()
	{
		super(0, 20);
	}

	public ValidityDate2Impl(ByteBuf value)
	{
		super(value, 0, 20);
	}
}