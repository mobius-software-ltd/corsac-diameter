...
*
*/
@DiameterAvpImplementation(code = 14L, vendorId = -1L)
public class LoginIPHostImpl extends DiameterIpv4AddressImpl implements LoginIPHost
{
	protected LoginIPHostImpl() 
	{
		super();
	}
	
	public LoginIPHostImpl(Inet4Address value) 
	{
		super(value);	
	}
}