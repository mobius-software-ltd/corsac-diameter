...
*
*/
@DiameterAvpImplementation(code = 20434L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class OrigIMSIImpl extends DiameterUTF8StringImpl implements OrigIMSI
{
	protected OrigIMSIImpl()
	{
		super(0, 20);
	}

	public OrigIMSIImpl(String value)
	{
		super(value, 0, 20);
	}
}