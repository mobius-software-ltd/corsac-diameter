...
*
*/
@DiameterAvpImplementation(code = 1036L, vendorId = KnownVendorIDs.TGPP_ID)
public class TunnelHeaderFilterImpl extends DiameterIpFilterRuleImpl implements TunnelHeaderFilter
{
	protected TunnelHeaderFilterImpl()
	{
		super();
	}

	protected TunnelHeaderFilterImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public TunnelHeaderFilterImpl(DiameterIpAction action, DiameterRuleDirection direction, InternetProtocol protocol, DiameterRuleAddress from, List<DiameterRulePorts> fromPorts,
	...
	public TunnelHeaderFilterImpl(String rule, Integer minLength, Integer maxLength) throws ParseException
	{
