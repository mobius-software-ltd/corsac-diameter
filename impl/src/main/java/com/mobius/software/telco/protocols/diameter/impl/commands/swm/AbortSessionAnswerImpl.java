...
*
*/
@DiameterCommandImplementation(applicationId = 16777264, commandCode = 274, request = false)
public class AbortSessionAnswerImpl extends SwmAnswerImpl implements AbortSessionAnswer
{
