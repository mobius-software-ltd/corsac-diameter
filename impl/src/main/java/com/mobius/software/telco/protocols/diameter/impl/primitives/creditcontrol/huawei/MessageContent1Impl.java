...
*
*/
@DiameterAvpImplementation(code = 20396L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class MessageContent1Impl extends DiameterUTF8StringImpl implements MessageContent1
{
	protected MessageContent1Impl()
	{
		super(0, 256);
	}

	public MessageContent1Impl(String value)
	{
		super(value, 0, 256);
	}
}