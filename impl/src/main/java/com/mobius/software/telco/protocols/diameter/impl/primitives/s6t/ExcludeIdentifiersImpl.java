...
*
*/
@DiameterAvpImplementation(code = 3188L, vendorId = KnownVendorIDs.TGPP_ID)
public class ExcludeIdentifiersImpl extends DiameterGroupedAvpImpl implements ExcludeIdentifiers
{
	private List<ExternalIdentifier> externalIdentifier;
	
	private List<MSISDN> msisdn;
	
	public ExcludeIdentifiersImpl()
	{
