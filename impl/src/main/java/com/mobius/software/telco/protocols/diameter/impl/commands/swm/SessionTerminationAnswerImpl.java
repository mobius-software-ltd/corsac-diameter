...
*
*/
@DiameterCommandImplementation(applicationId = 16777264, commandCode = 275, request = false)
public class SessionTerminationAnswerImpl extends SwmAnswerImpl implements SessionTerminationAnswer
{
