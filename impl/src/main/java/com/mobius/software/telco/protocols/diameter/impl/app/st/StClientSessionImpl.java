...
public class StClientSessionImpl extends ClientAuthSessionImpl<StRequest, StAnswer,ReAuthRequest,ReAuthAnswer,AbortSessionRequest,AbortSessionAnswer,SessionTerminationRequest,SessionTerminationAnswer> implements StClientSession
{
	public StClientSessionImpl()
	{
		super(Long.valueOf(ApplicationIDs.ST));
	}
	
	public StClientSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<? extends ClientAuthListener<StRequest, StAnswer,ReAuthRequest,ReAuthAnswer,AbortSessionRequest,AbortSessionAnswer,SessionTerminationRequest,SessionTerminationAnswer>, ?, ?, ?, ?> provider)
	{
