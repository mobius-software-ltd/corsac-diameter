...
*
*/
@DiameterAvpImplementation(code = 641L, vendorId = KnownVendorIDs.TGPP_ID)
public class ContactImpl extends DiameterOctetStringImpl implements Contact
{
	...
	protected ContactImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public ContactImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
