...
*
*/
@DiameterAvpImplementation(code = 1488L, vendorId = KnownVendorIDs.TGPP_ID)
public class CallBarringInfoImpl extends DiameterGroupedAvpImpl implements CallBarringInfo
{
	private SSCode ssCode;
	
	private SSStatus ssStatus;
	
	protected CallBarringInfoImpl()
	{
		
	}
	
	public CallBarringInfoImpl(ByteBuf ssCode,ByteBuf ssStatus)
	{
		if(ssCode==null)
