...
public class NIDDAuthorizationUpdateImpl extends DiameterGroupedAvpImpl implements NIDDAuthorizationUpdate
{
	...
	public NIDDAuthorizationUpdateImpl()
	{
		
	}
	
	public List<APNValidityTime> getAPNValidityTime()
	{
		return apnValidityTime;
	}
	
	public void setAPNValidityTime(List<APNValidityTime> value)
	{
		this.apnValidityTime = value;
	}
}