...
public class SwmServerSessionImpl extends ServerAuthSessionImpl<SwmRequest, SwmAnswer,ReAuthRequest,ReAuthAnswer,AbortSessionRequest,AbortSessionAnswer,SessionTerminationRequest,SessionTerminationAnswer> implements SwmServerSession
{
	public SwmServerSessionImpl()
	{
		super(Long.valueOf(ApplicationIDs.SWM));
	}
	
	public SwmServerSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<?, ? extends ServerAuthListener<SwmRequest, SwmAnswer,ReAuthRequest,ReAuthAnswer,AbortSessionRequest,AbortSessionAnswer,SessionTerminationRequest,SessionTerminationAnswer>, ?, ?, ?> provider)
	{
