...
*
*/
@DiameterAvpImplementation(code = 20399L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class MessageContent4Impl extends DiameterUTF8StringImpl implements MessageContent4
{
	protected MessageContent4Impl()
	{
		super(0, 256);
	}

	public MessageContent4Impl(String value)
	{
		super(value, 0, 256);
	}
}