...
public class HuaweiProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public HuaweiProviderImpl(DiameterStack stack)
	{
	...
	{		
		try
		{
			if(message instanceof CreditControlRequest)
				return new HuaweiServerSessionImpl(message.getSessionId(), message.getOriginHost(), message.getOriginRealm(), this);
		}
