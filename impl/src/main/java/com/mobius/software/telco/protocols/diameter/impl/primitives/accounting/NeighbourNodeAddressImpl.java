...
public class NeighbourNodeAddressImpl extends DiameterAddressImpl implements NeighbourNodeAddress
{
	...
	protected NeighbourNodeAddressImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public NeighbourNodeAddressImpl(InetAddress value, Integer minLength, Integer maxLength)
	{
