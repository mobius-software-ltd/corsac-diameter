...
*
*/
@DiameterAvpImplementation(code = 21213L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCalledGroupNumberImpl extends DiameterOctetStringImpl implements SCalledGroupNumber
{

	protected SCalledGroupNumberImpl()
	{
		super(0, 32);
	}

	public SCalledGroupNumberImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}