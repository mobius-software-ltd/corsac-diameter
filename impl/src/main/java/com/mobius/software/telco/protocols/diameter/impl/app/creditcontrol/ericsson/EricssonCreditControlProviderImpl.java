...
import com.mobius.software.telco.protocols.diameter.app.creditcontrol.ericsson.ClientListener;
import com.mobius.software.telco.protocols.diameter.app.creditcontrol.ericsson.MessageFactory;
import com.mobius.software.telco.protocols.diameter.app.creditcontrol.ericsson.ServerListener;
...
public class EricssonCreditControlProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(EricssonCreditControlProviderImpl.class);
	
	public EricssonCreditControlProviderImpl(DiameterStack stack,String packageName)
	{
	...
	{		
		try
		{
			if(message instanceof CreditControlRequest)
				return new EricssonCreditControlServerSessionImpl(message.getSessionId(), message.getOriginHost(), message.getOriginRealm(), this);
		}
