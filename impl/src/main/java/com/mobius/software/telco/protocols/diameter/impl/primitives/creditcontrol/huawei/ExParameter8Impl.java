...
*
*/
@DiameterAvpImplementation(code = 30319L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ExParameter8Impl extends DiameterUTF8StringImpl implements ExParameter8
{
	protected ExParameter8Impl()
	{
		super(0, 256);
	}

	public ExParameter8Impl(String value)
	{
		super(value, 0, 256);
	}
}