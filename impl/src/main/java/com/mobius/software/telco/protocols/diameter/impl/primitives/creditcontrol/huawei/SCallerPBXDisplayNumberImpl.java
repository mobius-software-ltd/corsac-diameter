...
public class SCallerPBXDisplayNumberImpl extends DiameterOctetStringImpl implements SCallerPBXDisplayNumber
{
	protected SCallerPBXDisplayNumberImpl()
	{
		super(0, 32);
	}

	public SCallerPBXDisplayNumberImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}