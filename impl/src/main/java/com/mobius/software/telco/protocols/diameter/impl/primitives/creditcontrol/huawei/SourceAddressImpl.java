...
*
*/
@DiameterAvpImplementation(code = 20406L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SourceAddressImpl extends DiameterUTF8StringImpl implements SourceAddress
{
	protected SourceAddressImpl()
	{
		super(0, 63);
	}

	public SourceAddressImpl(String value)
	{
		super(value, 0, 63);
	}
}