...
*
*/
public class SlhProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(SlhProviderImpl.class);
	
	public SlhProviderImpl(DiameterStack stack,String packageName)
	{
	...
	{		
		try
		{
			if(message instanceof SlhRequest)
				return new SlhServerSessionImpl(message.getSessionId(), message.getOriginHost(), message.getOriginRealm(), this);
		}
