...
*
*/
@DiameterAvpImplementation(code = 3177L, vendorId = KnownVendorIDs.TGPP_ID)
public class GroupUserIdentifierImpl extends DiameterGroupedAvpImpl implements GroupUserIdentifier
{
	...
	public GroupUserIdentifierImpl()
	{
