...
*
*/
public abstract class NtRequestImpl extends VendorSpecificRequestImpl implements NtRequest
{
	protected DRMP drmp;
	...
	protected NtRequestImpl() 
	{
		super();	
	}
		
	public NtRequestImpl(String originHost,String originRealm,String destinationHost,String destinationRealm,Boolean isRetransmit, String sessonID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
