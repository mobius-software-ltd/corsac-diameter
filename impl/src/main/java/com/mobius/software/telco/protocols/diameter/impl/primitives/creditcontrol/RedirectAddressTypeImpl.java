...
public class RedirectAddressTypeImpl extends DiameterEnumeratedImpl<RedirectAddressTypeEnum> implements RedirectAddressType
{
	...
	protected RedirectAddressTypeImpl(Integer minValue,Integer maxValue) 
	{
		super(minValue, maxValue);
	}
	
	public RedirectAddressTypeImpl(RedirectAddressTypeEnum value,Integer minValue,Integer maxValue) 
	{
