...
*
*/
@DiameterAvpImplementation(code = 20308L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CalledIMEIImpl extends DiameterUTF8StringImpl implements CalledIMEI
{
	protected CalledIMEIImpl()
	{
		super(0, 32);
	}

	public CalledIMEIImpl(String value)
	{
		super(value, 0, 32);
	}
}