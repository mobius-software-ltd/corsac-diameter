...
*
*/
@DiameterAvpImplementation(code = 20342L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CardNumberImpl extends DiameterOctetStringImpl implements CardNumber
{
	protected CardNumberImpl()
	{
		super(0, 32);
	}

	public CardNumberImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}