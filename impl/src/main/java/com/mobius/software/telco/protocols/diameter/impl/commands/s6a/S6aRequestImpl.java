...
*
*/
public abstract class S6aRequestImpl extends VendorSpecificRequestImpl implements S6aRequest
{
	protected DRMP drmp;
	...
	protected S6aRequestImpl() 
	{
		super();
	}
		
	public S6aRequestImpl(String originHost,String originRealm,String destinationHost,String destinationRealm,Boolean isRetransmit, String sessonID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
