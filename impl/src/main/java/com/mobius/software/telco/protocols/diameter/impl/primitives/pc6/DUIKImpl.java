...
*
*/
@DiameterAvpImplementation(code = 3863L, vendorId = KnownVendorIDs.TGPP_ID)
public class DUIKImpl extends DiameterOctetStringImpl implements DUIK
{
	protected DUIKImpl()
	{
		super();
	...
	protected DUIKImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public DUIKImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
