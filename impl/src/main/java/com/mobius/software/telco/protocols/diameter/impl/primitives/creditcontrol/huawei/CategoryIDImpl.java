...
*
*/
@DiameterAvpImplementation(code = 20639L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CategoryIDImpl extends DiameterUTF8StringImpl implements CategoryID
{
	...
	public CategoryIDImpl(String value)
	{
		super(value, 0, 16);
	}
}