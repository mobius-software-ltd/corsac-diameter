...
*
*/
public abstract class SwmRequestImpl extends AuthenticationRequestWithHostBase implements StaRequest
{
	protected DRMP drmp;
	...
	public SwmRequestImpl(String originHost,String originRealm, String destinationHost, String destinationRealm, Boolean isRetransmit, String sessonID, Long authApplicationId)
	{
