...
public class DiameterRuleAddress
{
	...
	//required for parser
	public DiameterRuleAddress(String value) throws ParseException
	{
		this.value = value;
		parseAddress();
	}
		
	public DiameterRuleAddress(Boolean isAssigned,Boolean isAny,Boolean isInverse) throws IllegalArgumentException 
	{
		this.address = null;
		this.bits = null;
	...
	public DiameterRuleAddress(InetAddress address,Integer bits,Boolean isInverse) throws IllegalArgumentException 
	{
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterRuleAddress other = (DiameterRuleAddress) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
