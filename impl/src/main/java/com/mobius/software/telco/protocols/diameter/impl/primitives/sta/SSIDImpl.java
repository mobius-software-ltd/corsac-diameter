...
*
*/
@DiameterAvpImplementation(code = 1524L, vendorId = KnownVendorIDs.TGPP_ID)
public class SSIDImpl extends DiameterUTF8StringImpl implements SSID
{
	protected SSIDImpl()
	{
		super();
	...
	protected SSIDImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public SSIDImpl(String value, Integer minLength, Integer maxLength)
	{
