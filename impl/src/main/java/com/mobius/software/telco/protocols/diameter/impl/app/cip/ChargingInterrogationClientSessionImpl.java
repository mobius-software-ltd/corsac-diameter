...
public class ChargingInterrogationClientSessionImpl extends ClientCCSessionImpl<ChargingInterrogationRequest,ChargingInterrogationAnswer,ReAuthRequest,ReAuthAnswer,AbortSessionRequest,AbortSessionAnswer,SessionTerminationRequest,SessionTerminationAnswer> implements ChargingInterrogationClientSession
{
	public ChargingInterrogationClientSessionImpl()
	{
		super(Long.valueOf(ApplicationIDs.CIP));
	}
	
	public ChargingInterrogationClientSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<? extends ClientCCListener<ChargingInterrogationRequest,ChargingInterrogationAnswer,ReAuthRequest,ReAuthAnswer,AbortSessionRequest,AbortSessionAnswer,SessionTerminationRequest,SessionTerminationAnswer>, ?, ?, ?, ?> provider)
	{
