...
public class PolicyCounterIdentifierImpl extends DiameterUTF8StringImpl implements PolicyCounterIdentifier
{
	...
	protected PolicyCounterIdentifierImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public PolicyCounterIdentifierImpl(String value, Integer minLength, Integer maxLength)
	{
