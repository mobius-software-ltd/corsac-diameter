...
*
*/
@DiameterAvpImplementation(code = 20302L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CallingVlrNumberImpl extends DiameterUTF8StringImpl implements CallingVlrNumber
{
	protected CallingVlrNumberImpl()
	{
		super(0, 32);
	}

	public CallingVlrNumberImpl(String value)
	{
		super(value, 0, 32);
	}
}