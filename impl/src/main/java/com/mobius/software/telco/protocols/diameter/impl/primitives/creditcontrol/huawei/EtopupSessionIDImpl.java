...
*
*/
@DiameterAvpImplementation(code = 20740L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class EtopupSessionIDImpl extends DiameterUTF8StringImpl implements EtopupSessionID
{
	protected EtopupSessionIDImpl()
	{
		super(0, 20);
	}

	public EtopupSessionIDImpl(String value)
	{
		super(value, 0, 20);
	}
}