...
public class ExtendedSCEFReferenceIDImpl extends DiameterUnsigned64Impl implements ExtendedSCEFReferenceID
{
	public ExtendedSCEFReferenceIDImpl()
	{
		super();
	}

	protected ExtendedSCEFReferenceIDImpl(Long minLength, Long maxLength)
	{
		super(minLength, maxLength);
	}

	public ExtendedSCEFReferenceIDImpl(Long value, Long minLength, Long maxLength)
	{
