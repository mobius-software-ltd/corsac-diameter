...
*
*/
@DiameterAvpImplementation(code = 20402L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SMIdImpl extends DiameterUTF8StringImpl implements SMId
{
	protected SMIdImpl()
	{
		super(0, 63);
