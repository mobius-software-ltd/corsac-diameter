...
*
*/
@DiameterAvpImplementation(code = 30321L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ExParameter10Impl extends DiameterUTF8StringImpl implements ExParameter10
{
	protected ExParameter10Impl()
	{
		super(0,256);
	}

	public ExParameter10Impl(String value)
	{
		super(value, 0, 256);
	}
}