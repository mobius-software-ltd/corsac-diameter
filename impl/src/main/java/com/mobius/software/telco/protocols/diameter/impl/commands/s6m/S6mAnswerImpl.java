...
*
*/
public abstract class S6mAnswerImpl extends DiameterAnswerWithSessionBase implements S6mAnswer
{
	protected DRMP drmp;
	...
	protected S6mAnswerImpl() 
	{
		super();
	}
	
	public S6mAnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
