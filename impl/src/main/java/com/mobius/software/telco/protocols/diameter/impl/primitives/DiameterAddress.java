...
public class DiameterAddress extends DiameterOctetString
{
	private InetAddress value;
	
	//required for parser
	public DiameterAddress() 
	{
		super();
	}
	
	public DiameterAddress(Integer minLength,Integer maxLength) 
	{
		super(minLength,maxLength);		
	}
	
	public DiameterAddress(InetAddress value,Integer minLength,Integer maxLength) 
	{
		super(Unpooled.wrappedBuffer(getBytes(value)),minLength,maxLength);	
		this.value = value;
	}
	
	public InetAddress getRealValue() 
	{
		return value;
	}
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterAddress other = (DiameterAddress) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
