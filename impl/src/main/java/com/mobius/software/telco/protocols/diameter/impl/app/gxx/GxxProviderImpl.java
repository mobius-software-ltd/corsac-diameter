...
import com.mobius.software.telco.protocols.diameter.app.gxx.ClientListener;
import com.mobius.software.telco.protocols.diameter.app.gxx.MessageFactory;
import com.mobius.software.telco.protocols.diameter.app.gxx.ServerListener;
...
public class GxxProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(GxxProviderImpl.class);
	
	public GxxProviderImpl(DiameterStack stack,String packageName)
	{
	...
	{		
		try
		{
			if(message instanceof CreditControlRequest)
				return new GxxServerSessionImpl(message.getSessionId(), message.getOriginHost(), message.getOriginRealm(), this);
		}
