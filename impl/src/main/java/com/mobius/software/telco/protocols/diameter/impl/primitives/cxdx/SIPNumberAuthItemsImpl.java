...
*
*/
@DiameterAvpImplementation(code = 607L, vendorId = KnownVendorIDs.TGPP_ID)
public class SIPNumberAuthItemsImpl extends DiameterUnsigned32Impl implements SIPNumberAuthItems
{
	...
	protected SIPNumberAuthItemsImpl(Long minValue, Long maxValue)
	{
		super(minValue, maxValue);
	}

	public SIPNumberAuthItemsImpl(Long value, Long minValue, Long maxValue)
	{
