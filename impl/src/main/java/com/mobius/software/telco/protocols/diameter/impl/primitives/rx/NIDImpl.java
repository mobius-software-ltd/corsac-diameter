...
*
*/
@DiameterAvpImplementation(code = 569L, vendorId = KnownVendorIDs.TGPP_ID)
public class NIDImpl extends DiameterOctetStringImpl implements NID
{
	protected NIDImpl()
	{
		super();
	...
	protected NIDImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public NIDImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
