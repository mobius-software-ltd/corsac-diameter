...
*
*/
@DiameterAvpImplementation(code = 518L, vendorId = -1L)
public class IPAddressImpl extends DiameterAddressImpl implements IPAddress
{
	...
	protected IPAddressImpl(Integer minLength,Integer maxLength) 
	{
		super(minLength,maxLength);		
	}
	
	public IPAddressImpl(InetAddress value,Integer minLength,Integer maxLength) 
	{
