...
*
*/
@DiameterAvpImplementation(code = 20357L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class AccountIDImpl extends DiameterOctetStringImpl implements AccountID
{

	protected AccountIDImpl()
	{
		super(0,32);
	}

	public AccountIDImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}