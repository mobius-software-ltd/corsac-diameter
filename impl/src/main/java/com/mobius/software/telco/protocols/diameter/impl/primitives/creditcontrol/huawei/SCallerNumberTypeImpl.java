...
*
*/
@DiameterAvpImplementation(code = 21209L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCallerNumberTypeImpl extends DiameterOctetStringImpl implements SCallerNumberType
{
	protected SCallerNumberTypeImpl()
	{
		super(0, 1);
	}

	public SCallerNumberTypeImpl(ByteBuf value)
	{
		super(value, 0, 1);
	}
}