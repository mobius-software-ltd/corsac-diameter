...
public class EnhancedCoverageRestrictionImpl extends DiameterGroupedAvpImpl implements EnhancedCoverageRestriction
{
	...
	private AllowedPLMNList allowedPLMNList;
	
	public EnhancedCoverageRestrictionImpl()
	{
	...
	{
		return restrictedPLMNList;
	}
	
	public void setRestrictedPLMNList(RestrictedPLMNList value)
	{
		this.restrictedPLMNList = value;
	}
	
	public AllowedPLMNList getAllowedPLMNList()
	{
		return allowedPLMNList;
	}
	
	public void setAllowedPLMNList(AllowedPLMNList value)
	{
		this.allowedPLMNList = value;
	}
}