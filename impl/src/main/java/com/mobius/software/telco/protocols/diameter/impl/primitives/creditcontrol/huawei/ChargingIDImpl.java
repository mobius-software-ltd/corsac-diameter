...
*
*/
@DiameterAvpImplementation(code = 20527L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ChargingIDImpl extends DiameterUTF8StringImpl implements ChargingID
{
	protected ChargingIDImpl()
	{
		super(0, 10);
	}

	public ChargingIDImpl(String value)
	{
		super(value, 0, 10);
	}
}