...
*
*/
@DiameterAvpImplementation(code = 610L, vendorId = KnownVendorIDs.TGPP_ID)
public class SIPAuthorizationImpl extends DiameterOctetStringImpl implements SIPAuthorization
{
	...
	protected SIPAuthorizationImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public SIPAuthorizationImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
