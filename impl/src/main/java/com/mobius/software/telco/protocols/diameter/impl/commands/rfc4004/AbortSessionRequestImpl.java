...
import com.mobius.software.telco.protocols.diameter.commands.rfc4004.AbortSessionRequest;
...
*
*/
@DiameterCommandImplementation(applicationId = 2, commandCode = 274, request = true)
