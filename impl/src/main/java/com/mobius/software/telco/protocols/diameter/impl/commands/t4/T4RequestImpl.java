...
public abstract class T4RequestImpl extends VendorSpecificRequestmpl implements T4Request
{
	...
	public T4RequestImpl(String originHost,String originRealm,String destinationHost,String destinationRealm,Boolean isRetransmit, String sessonID, AuthSessionStateEnum authSessionState)
	{
