...
*
*/
@DiameterAvpImplementation(code = 21207L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCalledLongNumberImpl extends DiameterOctetStringImpl implements SCalledLongNumber
{
	protected SCalledLongNumberImpl()
	{
		super(0, 32);
	}

	public SCalledLongNumberImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}