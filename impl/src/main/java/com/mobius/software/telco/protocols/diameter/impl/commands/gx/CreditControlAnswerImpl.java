...
*
*/
@DiameterCommandImplementation(applicationId = 16777238, commandCode = 272, request = false)
public class CreditControlAnswerImpl extends AuthenticationAnswerImpl implements CreditControlAnswer
{
	...
	public void setConditionalPolicyInformation(List<ConditionalPolicyInformation> value)
	{
		if(value!=null && value.size()>4)
			throw new IllegalArgumentException("Up to 4 Conditional-Policy-Information allowed");
