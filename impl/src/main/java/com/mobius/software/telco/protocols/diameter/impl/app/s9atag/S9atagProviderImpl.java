...
import com.mobius.software.telco.protocols.diameter.app.s9atag.ClientListener;
import com.mobius.software.telco.protocols.diameter.app.s9atag.MessageFactory;
import com.mobius.software.telco.protocols.diameter.app.s9atag.ServerListener;
...
public class S9atagProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(S9atagProviderImpl.class);
	
	public S9atagProviderImpl(DiameterStack stack,String packageName)
	{
	...
	{		
		try
		{
			if(message instanceof CreditControlRequest)
				return new S9atagServerSessionImpl(message.getSessionId(), message.getOriginHost(), message.getOriginRealm(), this);
		}
