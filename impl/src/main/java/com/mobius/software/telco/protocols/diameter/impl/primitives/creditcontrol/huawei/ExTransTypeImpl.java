...
*
*/
@DiameterAvpImplementation(code = 21400L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ExTransTypeImpl extends DiameterUTF8StringImpl implements ExTransType
{
	protected ExTransTypeImpl()
	{
		super(0, 32);
	}

	public ExTransTypeImpl(String value)
	{
		super(value, 0, 32);
	}
}