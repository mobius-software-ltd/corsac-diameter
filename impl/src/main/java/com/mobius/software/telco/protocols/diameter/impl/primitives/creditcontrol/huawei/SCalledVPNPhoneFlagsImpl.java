...
*
*/
@DiameterAvpImplementation(code = 21217L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCalledVPNPhoneFlagsImpl extends DiameterOctetStringImpl implements SCalledVPNPhoneFlags
{
	protected SCalledVPNPhoneFlagsImpl()
	{
		super(0, 64);
	}

	public SCalledVPNPhoneFlagsImpl(ByteBuf value)
	{
		super(value, 0, 64);
	}
}