...
public class DiameterUnsigned32 
{
	private Long value;
	...
	//required for parser
	public DiameterUnsigned32() 
	{
		
	}
	
	public DiameterUnsigned32(Long minValue,Long maxValue) 
	{
		this.minValue = minValue;
		this.maxValue = maxValue;
	}
	
	public DiameterUnsigned32(Long value,Long minValue,Long maxValue) 
	{
		this.value=value;
		this.minValue = minValue;
		this.maxValue = maxValue;
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterUnsigned32 other = (DiameterUnsigned32) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
