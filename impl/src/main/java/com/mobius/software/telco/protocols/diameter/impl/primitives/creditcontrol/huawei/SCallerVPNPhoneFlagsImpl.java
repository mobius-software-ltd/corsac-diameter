...
*
*/
@DiameterAvpImplementation(code = 21210L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCallerVPNPhoneFlagsImpl extends DiameterOctetStringImpl implements SCallerVPNPhoneFlags
{
	protected SCallerVPNPhoneFlagsImpl()
	{
		super(0,64);
	}

	public SCallerVPNPhoneFlagsImpl(ByteBuf value)
	{
		super(value, 0, 64);
	}
}