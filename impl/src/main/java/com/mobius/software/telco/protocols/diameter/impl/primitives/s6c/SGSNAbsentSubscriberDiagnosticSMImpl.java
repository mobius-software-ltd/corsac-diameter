...
public class SGSNAbsentSubscriberDiagnosticSMImpl extends DiameterUnsigned32Impl implements SGSNAbsentSubscriberDiagnosticSM
{
	...
	protected SGSNAbsentSubscriberDiagnosticSMImpl(Long minValue, Long maxValue)
	{
		super(minValue, maxValue);
	}

	public SGSNAbsentSubscriberDiagnosticSMImpl(Long value, Long minValue, Long maxValue)
	{
