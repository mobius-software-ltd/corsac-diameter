...
*
*/
public abstract class S6cAnswerImpl extends VendorSpecificAnswerImpl implements S6cAnswer
{
	protected DRMP drmp;
	...
	protected S6cAnswerImpl() 
	{
		super();
	}
	
	public S6cAnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
