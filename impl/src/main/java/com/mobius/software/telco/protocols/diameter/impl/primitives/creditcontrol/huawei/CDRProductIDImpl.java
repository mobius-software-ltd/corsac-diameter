...
*
*/
@DiameterAvpImplementation(code = 20625L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CDRProductIDImpl extends DiameterUTF8StringImpl implements CDRProductID
{
	protected CDRProductIDImpl()
	{
		super(0, 32);
	}

	public CDRProductIDImpl(String value)
	{
		super(value, 0, 32);
	}
}