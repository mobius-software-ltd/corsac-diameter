...
public class AccessNetworkChargingAddressImpl extends DiameterAddressImpl implements AccessNetworkChargingAddress
{
	...
	protected AccessNetworkChargingAddressImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}
	
	public AccessNetworkChargingAddressImpl(InetAddress value, Integer minLength, Integer maxLength)
	{
