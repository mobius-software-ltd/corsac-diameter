...
*
*/
@DiameterAvpImplementation(code = 20922L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ServiceParameterValueImpl extends DiameterInteger64Impl implements ServiceParameterValue
{
	...
	protected ServiceParameterValueImpl(Long minValue, Long maxValue)
	{
		super(minValue, maxValue);
	}

	public ServiceParameterValueImpl(Long value, Long minValue, Long maxValue)
	{
