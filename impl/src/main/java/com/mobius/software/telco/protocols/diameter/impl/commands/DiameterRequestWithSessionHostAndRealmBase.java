...
*
*/
public abstract class DiameterRequestWithSessionHostAndRealmBase extends DiameterRequestWithSessionAndRealmBase
{
	protected DiameterRequestWithSessionHostAndRealmBase()
	{
		super();
	}
	
	public DiameterRequestWithSessionHostAndRealmBase(String originHost,String originRealm,String destinationHost,String destinationRealm,Boolean isRetransmit, String sessionID)
	{	
