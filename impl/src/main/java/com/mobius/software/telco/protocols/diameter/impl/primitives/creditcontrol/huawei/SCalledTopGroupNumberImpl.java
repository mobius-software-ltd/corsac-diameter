...
*
*/
@DiameterAvpImplementation(code = 21214L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCalledTopGroupNumberImpl extends DiameterOctetStringImpl implements SCalledTopGroupNumber
{
	protected SCalledTopGroupNumberImpl()
	{
		super(0, 32);
	}

	public SCalledTopGroupNumberImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}