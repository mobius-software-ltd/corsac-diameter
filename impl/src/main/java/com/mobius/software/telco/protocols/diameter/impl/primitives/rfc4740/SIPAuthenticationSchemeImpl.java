...
public class SIPAuthenticationSchemeImpl extends DiameterEnumeratedImpl<SIPAuthenticationSchemeEnum> implements SIPAuthenticationScheme
{
	...
	protected SIPAuthenticationSchemeImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}

	public SIPAuthenticationSchemeImpl(SIPAuthenticationSchemeEnum value, Integer minValue, Integer maxValue)
	{
