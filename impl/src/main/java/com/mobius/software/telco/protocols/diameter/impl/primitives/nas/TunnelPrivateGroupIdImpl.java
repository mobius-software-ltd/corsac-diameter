...
public class TunnelPrivateGroupIdImpl extends DiameterOctetStringImpl implements TunnelPrivateGroupId
{
	...
	protected TunnelPrivateGroupIdImpl(Integer minLength,Integer maxLength) 
	{
		super(minLength,maxLength);
	}
	
	public TunnelPrivateGroupIdImpl(ByteBuf value,Integer minLength,Integer maxLength) 
	{
