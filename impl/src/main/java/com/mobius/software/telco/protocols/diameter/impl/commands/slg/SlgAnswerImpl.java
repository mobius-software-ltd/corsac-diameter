...
*
*/
public abstract class SlgAnswerImpl extends VendorSpecificAnswerImpl implements SlgAnswer
{
	protected DRMP drmp;
	...
	protected SlgAnswerImpl() 
	{
		super();
	}
	
	public SlgAnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
