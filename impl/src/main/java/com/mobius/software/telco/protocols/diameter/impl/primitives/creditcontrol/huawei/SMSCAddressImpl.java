...
*
*/
@DiameterAvpImplementation(code = 20401L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SMSCAddressImpl extends DiameterUTF8StringImpl implements SMSCAddress
{
	...
	public SMSCAddressImpl(String value)
	{
		super(value, 0, 32);
	}
}