...
*
*/
@DiameterAvpImplementation(code = 3158L, vendorId = KnownVendorIDs.TGPP_ID)
public class AllowedPLMNListImpl extends DiameterGroupedAvpImpl implements AllowedPLMNList
{
	private List<VisitedPLMNId> visitedPLMNId;
	
	public AllowedPLMNListImpl()
	{
