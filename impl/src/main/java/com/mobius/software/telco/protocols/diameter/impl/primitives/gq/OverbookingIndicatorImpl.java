...
public class OverbookingIndicatorImpl extends DiameterEnumeratedImpl<OverbookingIndicatorEnum> implements OverbookingIndicator
{
	...
	protected OverbookingIndicatorImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}

	public OverbookingIndicatorImpl(OverbookingIndicatorEnum value, Integer minValue, Integer maxValue)
	{
