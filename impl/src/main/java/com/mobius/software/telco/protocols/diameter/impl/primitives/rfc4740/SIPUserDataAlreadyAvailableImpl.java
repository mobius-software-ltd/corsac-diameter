...
public class SIPUserDataAlreadyAvailableImpl extends DiameterEnumeratedImpl<SIPUserDataAlreadyAvailableEnum> implements SIPUserDataAlreadyAvailable
{
	...
	protected SIPUserDataAlreadyAvailableImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}

	public SIPUserDataAlreadyAvailableImpl(SIPUserDataAlreadyAvailableEnum value, Integer minValue, Integer maxValue)
	{
