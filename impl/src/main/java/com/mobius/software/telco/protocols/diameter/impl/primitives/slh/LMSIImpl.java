...
*
*/
@DiameterAvpImplementation(code = 2400L, vendorId = KnownVendorIDs.TGPP_ID)
public class LMSIImpl extends DiameterOctetStringImpl implements LMSI
{
	protected LMSIImpl()
	{
		super();
	...
	protected LMSIImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public LMSIImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
