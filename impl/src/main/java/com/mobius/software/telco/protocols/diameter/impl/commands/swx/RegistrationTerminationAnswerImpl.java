...
*
*/
@DiameterCommandImplementation(applicationId = 16777265, commandCode = 304, request = false)
public class RegistrationTerminationAnswerImpl extends SwxAnswerImpl implements RegistrationTerminationAnswer
{
