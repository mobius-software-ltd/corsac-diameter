...
*
*/
@DiameterAvpImplementation(code = 4L, vendorId = -1L)
public class NASIPAddressImpl extends DiameterIpv4AddressImpl implements NASIPAddress
{
	protected NASIPAddressImpl() 
	{
		super();
	}
	
	public NASIPAddressImpl(Inet4Address value) 
	{
		super(value);	
	}
}