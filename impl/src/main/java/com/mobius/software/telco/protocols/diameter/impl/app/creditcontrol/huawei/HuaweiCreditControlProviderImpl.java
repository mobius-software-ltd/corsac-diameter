...
import com.mobius.software.telco.protocols.diameter.app.creditcontrol.huawei.AvpFactory;
...
public class HuaweiCreditControlProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(HuaweiCreditControlProviderImpl.class);
	
	public HuaweiCreditControlProviderImpl(DiameterStack stack,String packageName)
	{
	...
	{		
		try
		{
			if(message instanceof CreditControlRequest)
				return new HuaweiCreditControlServerSessionImpl(message.getSessionId(), message.getOriginHost(), message.getOriginRealm(), this);
		}
