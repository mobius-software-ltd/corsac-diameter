...
*
*/
public abstract class S6cRequestImpl extends VendorSpecificRequestImpl implements S6cRequest
{
	protected DRMP drmp;
	...
	protected S6cRequestImpl() 
	{
		super();
	}
		
	public S6cRequestImpl(String originHost,String originRealm,String destinationHost,String destinationRealm,Boolean isRetransmit, String sessonID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
