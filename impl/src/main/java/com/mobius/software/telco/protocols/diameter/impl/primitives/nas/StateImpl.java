...
*
*/
@DiameterAvpImplementation(code = 24L, vendorId = -1L)
public class StateImpl extends DiameterOctetStringImpl implements State
{
	protected StateImpl() 
	{
		super();
	...
	protected StateImpl(Integer minLength,Integer maxLength) 
	{
		super(minLength, maxLength);
	}
	
	public StateImpl(ByteBuf value,Integer minLength,Integer maxLength) 
	{
