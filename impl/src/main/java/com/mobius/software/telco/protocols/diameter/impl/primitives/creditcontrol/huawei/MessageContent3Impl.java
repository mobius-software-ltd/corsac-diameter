...
*
*/
@DiameterAvpImplementation(code = 20398L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class MessageContent3Impl extends DiameterUTF8StringImpl implements MessageContent3
{
	protected MessageContent3Impl()
	{
		super(0, 256);
	}

	public MessageContent3Impl(String value)
	{
		super(value, 0, 256);
	}
}