...
*
*/
@DiameterAvpImplementation(code = 3100L, vendorId = KnownVendorIDs.TGPP_ID)
public class IPSMGWNumberImpl extends DiameterE164AddressImpl implements IPSMGWNumber
{
	protected IPSMGWNumberImpl()
	{
		super();
	}

	public IPSMGWNumberImpl(String value)
	{
		super(value);
	}
}