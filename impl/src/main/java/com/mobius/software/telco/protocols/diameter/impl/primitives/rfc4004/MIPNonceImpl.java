...
*
*/
@DiameterAvpImplementation(code = 335L, vendorId = -1L)
public class MIPNonceImpl extends DiameterOctetStringImpl implements MIPNonce
{
	protected MIPNonceImpl() 
	{
		super();
	}
	
	protected MIPNonceImpl(Integer minLength,Integer maxLength) 
	{
		super(minLength, maxLength);
	}
	
	public MIPNonceImpl(ByteBuf value,Integer minLength,Integer maxLength) 
	{
