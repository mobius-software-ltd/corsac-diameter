...
*
*/
public abstract class T6aAnswerImpl extends DiameterAnswerWithSessionBase implements T6aAnswer
{
	protected DRMP drmp;
	...
	protected T6aAnswerImpl() 
	{
		super();
	}
	
	public T6aAnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
