...
*
*/
@DiameterAvpImplementation(code = 3605L, vendorId = KnownVendorIDs.TGPP_ID)
public class ApplicationDataImpl extends DiameterUTF8StringImpl implements ApplicationData
{
	...
	protected ApplicationDataImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public ApplicationDataImpl(String value, Integer minLength, Integer maxLength)
	{
