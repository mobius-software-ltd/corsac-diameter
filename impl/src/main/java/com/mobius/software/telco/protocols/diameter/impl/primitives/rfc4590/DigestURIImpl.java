...
*
*/
@DiameterAvpImplementation(code = 109L, vendorId = -1)
public class DigestURIImpl extends DiameterUTF8StringImpl implements DigestURI
{
	protected DigestURIImpl()
	{
		super();
	}

	protected DigestURIImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public DigestURIImpl(String value, Integer minLength, Integer maxLength)
	{
