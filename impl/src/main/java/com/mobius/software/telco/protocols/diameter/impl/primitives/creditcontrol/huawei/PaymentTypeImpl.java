...
*
*/
@DiameterAvpImplementation(code = 60002L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class PaymentTypeImpl extends DiameterInteger32Impl implements PaymentType
{
	...
	protected PaymentTypeImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}

	public PaymentTypeImpl(Integer value, Integer minValue, Integer maxValue)
	{
