...
*
*/
@DiameterCommandImplementation(applicationId = 16777217, commandCode = 309, request = false)
public class PushNotificationsAnswerImpl extends ShAnswerImpl implements PushNotificationAnswer
{
