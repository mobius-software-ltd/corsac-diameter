...
public class InitialGateSettingIDImpl extends DiameterUTF8StringImpl implements InitialGateSettingID
{
	...
	protected InitialGateSettingIDImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public InitialGateSettingIDImpl(String value, Integer minLength, Integer maxLength)
	{
