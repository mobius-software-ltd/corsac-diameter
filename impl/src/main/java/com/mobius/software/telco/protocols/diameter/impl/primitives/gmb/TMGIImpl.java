...
*
*/
@DiameterAvpImplementation(code = 900L, vendorId = KnownVendorIDs.TGPP_ID)
public class TMGIImpl extends DiameterOctetStringImpl implements TMGI
{
	protected TMGIImpl()
	{
		super();
	...
	protected TMGIImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public TMGIImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
