...
*
*/
@DiameterCommandImplementation(applicationId = 2, commandCode = 262, request = false)
public class HomeAgentMIPAnswerImpl extends DiameterAnswerWithSessionBase implements HomeAgentMIPAnswer
{
	...
	public HomeAgentMIPAnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID, Long authApplicationId)
	{
