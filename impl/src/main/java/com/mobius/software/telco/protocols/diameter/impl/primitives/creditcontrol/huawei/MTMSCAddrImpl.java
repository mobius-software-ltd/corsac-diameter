...
*
*/
@DiameterAvpImplementation(code = 20405L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class MTMSCAddrImpl extends DiameterUTF8StringImpl implements MTMSCAddr
{
	protected MTMSCAddrImpl()
	{
		super(0, 32);
	}

	public MTMSCAddrImpl(String value)
	{
		super(value, 0, 32);
	}
}