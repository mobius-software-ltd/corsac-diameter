...
*
*/
@DiameterAvpImplementation(code = 3107L, vendorId = KnownVendorIDs.TGPP_ID)
public class ServiceDataImpl extends DiameterGroupedAvpImpl implements ServiceData
{
	private T4Data t4Data;
	...
	public void setT4Data(T4Data value)
	{
		this.t4Data = value;
	}
}