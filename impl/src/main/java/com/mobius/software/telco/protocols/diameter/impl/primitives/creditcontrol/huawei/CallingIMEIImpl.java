...
*
*/
@DiameterAvpImplementation(code = 20309L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CallingIMEIImpl extends DiameterUTF8StringImpl implements CallingIMEI
{
	protected CallingIMEIImpl()
	{
		super(0, 32);
	}

	public CallingIMEIImpl(String value)
	{
		super(value, 0, 32);
	}
}