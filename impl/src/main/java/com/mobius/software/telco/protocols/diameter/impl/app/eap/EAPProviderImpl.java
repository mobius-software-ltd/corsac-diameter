...
import com.mobius.software.telco.protocols.diameter.app.eap.AvpFactory;
...
public class EAPProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(EAPProviderImpl.class);
	...
	{		
		try
		{
			if(message instanceof EAPRequest)
				return new EAPAuthServerSessionImpl(message.getSessionId(), message.getOriginHost(), message.getOriginRealm(), this);
		}
