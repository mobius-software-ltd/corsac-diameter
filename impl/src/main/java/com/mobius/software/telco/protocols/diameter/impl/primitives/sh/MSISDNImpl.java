...
*
*/
@DiameterAvpImplementation(code = 701L, vendorId = KnownVendorIDs.TGPP_ID)
public class MSISDNImpl extends DiameterE164AddressImpl implements MSISDN
{
	protected MSISDNImpl() 
	{
		super();
	}
	
	public MSISDNImpl(String value) 
	{
		super(value);
	}
}