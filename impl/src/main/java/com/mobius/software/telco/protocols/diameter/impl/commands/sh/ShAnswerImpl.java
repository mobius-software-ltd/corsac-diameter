...
*
*/
public abstract class ShAnswerImpl extends VendorSpecificAnswerImpl implements ShAnswer
{
	protected DRMP drmp;
	...
	protected ShAnswerImpl() 
	{
		super();
	}
	
	public ShAnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
