...
*
*/
@DiameterAvpImplementation(code = 1687L, vendorId = KnownVendorIDs.TGPP_ID)
public class EmergencyInfoImpl extends DiameterGroupedAvpImpl implements EmergencyInfo
{
	private MIP6AgentInfo mip6AgentInfo;
	
	public EmergencyInfoImpl()
	{
