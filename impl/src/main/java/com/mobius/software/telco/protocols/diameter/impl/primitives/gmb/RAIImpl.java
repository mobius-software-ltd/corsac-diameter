...
*
*/
@DiameterAvpImplementation(code = 909L, vendorId = KnownVendorIDs.TGPP_ID)
public class RAIImpl extends DiameterUTF8StringImpl implements RAI
{
	protected RAIImpl()
	{
		super();
	...
	protected RAIImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public RAIImpl(String value, Integer minLength, Integer maxLength)
	{
