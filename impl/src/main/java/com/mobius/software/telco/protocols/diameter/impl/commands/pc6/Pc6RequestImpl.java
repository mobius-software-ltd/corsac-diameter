...
*
*/
public abstract class Pc6RequestImpl extends VendorSpecificRequestImpl implements Pc6Request
{
	protected DRMP drmp;
	...
	protected Pc6RequestImpl() 
	{
		super();
	}
		
	public Pc6RequestImpl(String originHost,String originRealm,String destinationHost,String destinationRealm,Boolean isRetransmit, String sessonID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
