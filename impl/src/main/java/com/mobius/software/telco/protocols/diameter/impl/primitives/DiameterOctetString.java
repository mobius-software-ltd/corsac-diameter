...
public class DiameterOctetString 
{
	...
	//required for parser
	public DiameterOctetString() 
	{
		
	}
	
	public DiameterOctetString(Integer minLength,Integer maxLength) 
	{
		this.minLength = minLength;
		this.maxLength = maxLength;
	}
	
	public DiameterOctetString(ByteBuf value,Integer minLength,Integer maxLength) 
	{
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterOctetString other = (DiameterOctetString) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
