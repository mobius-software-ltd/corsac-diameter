...
public class SIPCreditControlServerURIImpl extends DiameterUriImpl implements SIPCreditControlServerURI
{
	...
	protected SIPCreditControlServerURIImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public SIPCreditControlServerURIImpl(String host, Integer port, Boolean isSecure, DiameterTransport transport, DiameterProtocol protocol, Integer minLength, Integer maxLength)
	{
