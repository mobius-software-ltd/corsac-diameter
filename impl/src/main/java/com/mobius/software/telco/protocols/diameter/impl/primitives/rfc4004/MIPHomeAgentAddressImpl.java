...
public class MIPHomeAgentAddressImpl extends DiameterAddressImpl implements MIPHomeAgentAddress
{
	...
	protected MIPHomeAgentAddressImpl(Integer minLength,Integer maxLength) 
	{
		super(minLength,maxLength);		
	}
	
	public MIPHomeAgentAddressImpl(InetAddress value,Integer minLength,Integer maxLength) 
	{
