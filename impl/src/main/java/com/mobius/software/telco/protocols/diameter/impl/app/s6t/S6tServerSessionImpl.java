...
{
	public S6tServerSessionImpl()
	{
		super(Long.valueOf(ApplicationIDs.S6T));
	}
	
	public S6tServerSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<?, ? extends ServerAuthStatelessListener<S6tRequest, S6tAnswer>, ?, ?, ?> provider)
	{
