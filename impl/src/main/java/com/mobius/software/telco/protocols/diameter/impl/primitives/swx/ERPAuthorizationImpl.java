...
public class ERPAuthorizationImpl extends DiameterEnumeratedImpl<ERPAuthorizationEnum> implements ERPAuthorization
{
	...
	protected ERPAuthorizationImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}

	public ERPAuthorizationImpl(ERPAuthorizationEnum value, Integer minValue, Integer maxValue)
	{
