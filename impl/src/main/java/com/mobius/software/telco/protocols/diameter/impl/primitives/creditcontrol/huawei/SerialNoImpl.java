...
*
*/
@DiameterAvpImplementation(code = 20391L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SerialNoImpl extends DiameterUTF8StringImpl implements SerialNo
{
	protected SerialNoImpl()
	{
		super(0, 32);
	}

	public SerialNoImpl(String value)
	{
		super(value, 0, 32);
	}
}