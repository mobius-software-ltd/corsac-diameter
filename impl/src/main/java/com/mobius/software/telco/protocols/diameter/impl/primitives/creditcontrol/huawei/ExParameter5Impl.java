...
*
*/
@DiameterAvpImplementation(code = 30316L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ExParameter5Impl extends DiameterUTF8StringImpl implements ExParameter5
{
	protected ExParameter5Impl()
	{
		super(0, 256);
	}

	public ExParameter5Impl(String value)
	{
		super(value, 0, 256);
	}
}