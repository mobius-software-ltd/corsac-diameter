...
*
*/
@DiameterAvpImplementation(code = 3862L, vendorId = KnownVendorIDs.TGPP_ID)
public class DUSKImpl extends DiameterOctetStringImpl implements DUSK
{
	protected DUSKImpl()
	{
		super();
	...
	protected DUSKImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public DUSKImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
