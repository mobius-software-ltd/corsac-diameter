...
*
*/
@DiameterAvpImplementation(code = 20634L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CDRPkgSpIdImpl extends DiameterUTF8StringImpl implements CDRPkgSpId
{
	protected CDRPkgSpIdImpl()
	{
		super(0, 36);
	}

	public CDRPkgSpIdImpl(String value)
	{
		super(value, 0, 36);
	}
}