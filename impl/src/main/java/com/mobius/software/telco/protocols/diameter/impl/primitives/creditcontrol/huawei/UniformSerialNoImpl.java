...
*
*/
@DiameterAvpImplementation(code = 20786L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class UniformSerialNoImpl extends DiameterUTF8StringImpl implements UniformSerialNo
{
	protected UniformSerialNoImpl()
	{
		super(0, 32);
	}

	public UniformSerialNoImpl(String value)
	{
		super(value, 0, 32);
	}
}