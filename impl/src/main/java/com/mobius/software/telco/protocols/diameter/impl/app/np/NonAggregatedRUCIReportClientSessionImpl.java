...
public class NonAggregatedRUCIReportClientSessionImpl extends ClientAuthSessionStatelessImpl<NonAggregatedRUCIReportRequest, NonAggregatedRUCIReportAnswer> implements NonAggregatedRUCIReportClientSession
{
	public NonAggregatedRUCIReportClientSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<? extends ClientAuthStatelessListener, ?, ?, ?, ?> provider)
	{
