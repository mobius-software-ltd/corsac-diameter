...
public class MetadataIndicatorImpl extends DiameterEnumeratedImpl<MetadataIndicatorEnum> implements MetadataIndicator
{
	...
	protected MetadataIndicatorImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}

	public MetadataIndicatorImpl(MetadataIndicatorEnum value, Integer minValue, Integer maxValue)
	{
