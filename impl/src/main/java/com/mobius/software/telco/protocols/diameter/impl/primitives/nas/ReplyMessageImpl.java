...
*
*/
@DiameterAvpImplementation(code = 18L, vendorId = -1L)
public class ReplyMessageImpl extends DiameterUTF8StringImpl implements ReplyMessage
{
	...
	protected ReplyMessageImpl(Integer minLength,Integer maxLength) 
	{
		super(minLength,maxLength);
	}
	
	public ReplyMessageImpl(String value,Integer minLength,Integer maxLength) 
	{
