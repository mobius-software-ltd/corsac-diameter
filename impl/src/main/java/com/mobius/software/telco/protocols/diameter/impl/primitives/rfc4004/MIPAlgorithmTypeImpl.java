...
public class MIPAlgorithmTypeImpl extends DiameterEnumeratedImpl<MIPAlgorithmTypeEnum> implements MIPAlgorithmType
{
	protected MIPAlgorithmTypeImpl() 
	{
		super();
	}
	
	protected MIPAlgorithmTypeImpl(Integer minValue,Integer maxValue) 
	{
		super(minValue, maxValue);
	}
	
	public MIPAlgorithmTypeImpl(MIPAlgorithmTypeEnum value,Integer minValue,Integer maxValue) 
	{
