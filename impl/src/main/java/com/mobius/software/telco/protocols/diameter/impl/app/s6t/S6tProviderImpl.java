...
*
*/
public class S6tProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(S6tProviderImpl.class);
	
	public S6tProviderImpl(DiameterStack stack,String packageName)
	{
