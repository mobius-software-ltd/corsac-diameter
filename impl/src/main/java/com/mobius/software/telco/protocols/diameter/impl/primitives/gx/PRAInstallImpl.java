...
*
*/
@DiameterAvpImplementation(code = 2845L, vendorId = KnownVendorIDs.TGPP_ID)
public class PRAInstallImpl extends DiameterGroupedAvpImpl implements PRAInstall
{
	private List<PresenceReportingAreaInformation> presenceReportingAreaInformation;
	
	public PRAInstallImpl()
	{
