...
*
*/
@DiameterAvpImplementation(code = 21208L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCallerShortNumberImpl extends DiameterOctetStringImpl implements SCallerShortNumber
{

	protected SCallerShortNumberImpl()
	{
		super(0, 16);
	}

	public SCallerShortNumberImpl(ByteBuf value)
	{
		super(value, 0, 16);
	}
}