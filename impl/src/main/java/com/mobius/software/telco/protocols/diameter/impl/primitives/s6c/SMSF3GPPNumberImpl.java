...
*
*/
@DiameterAvpImplementation(code = 3338L, vendorId = KnownVendorIDs.TGPP_ID)
public class SMSF3GPPNumberImpl extends DiameterE164AddressImpl implements SMSF3GPPNumber
{
	protected SMSF3GPPNumberImpl()
	{
		super();
	}

	public SMSF3GPPNumberImpl(String value)
	{
		super(value);
	}
}