...
*
*/
public abstract class StAnswerImpl extends VendorSpecificAnswerImpl implements StAnswer
{
	private DRMP drmp;
	...
	protected StAnswerImpl() 
	{
		super();
	}
	
	public StAnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID)
	{
