...
public class CIRFlagsImpl extends DiameterBitmask32Impl implements CIRFlags
{
	...
	{
		setBitUnchecked(DELETED_ALL_MONITORING_EVENTS_BIT, isOn);
	}
	...
	{
		setBitUnchecked(ENHANCED_COVERAGE_QUERY_BIT, isOn);
	}
	...
	{
		setBitUnchecked(IMSI_GROUP_ID_RETRIEVAL_BIT, isOn);
	}
	...
	{
		setBitUnchecked(DELETE_ALL_COMMUNICATION_PATTERN_BIT, isOn);
	}
	...
	{
		setBitUnchecked(DELETE_ALL_NETWORK_PARAMETER_CONFIGURATIONS_BIT, isOn);
	}
