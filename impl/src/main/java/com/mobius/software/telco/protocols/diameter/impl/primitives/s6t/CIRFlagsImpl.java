...
public class CIRFlagsImpl extends DiameterUnsigned32Impl implements CIRFlags
{
	protected CIRFlagsImpl()
	{
		super();
	}

	protected CIRFlagsImpl(Long minValue, Long maxValue)
	{
		super(minValue, maxValue);
	}

	public CIRFlagsImpl(Long value, Long minValue, Long maxValue)
	{
