...
*
*/
@DiameterAvpImplementation(code = 30806L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class AuthSubServiceKeyImpl extends DiameterUTF8StringImpl implements AuthSubServiceKey
{
	protected AuthSubServiceKeyImpl()
	{
		super(0,36);
	}

	public AuthSubServiceKeyImpl(String value)
	{
		super(value, 0, 36);
	}
}