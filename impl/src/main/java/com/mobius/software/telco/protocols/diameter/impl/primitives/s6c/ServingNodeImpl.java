...
import com.mobius.software.telco.protocols.diameter.primitives.s6c.IPSMGWSBISupportIndicatorEnum;
...
public class ServingNodeImpl extends DiameterGroupedAvpImpl implements ServingNode
{
	...
	private IPSMGWSBISupportIndicator ipSMGWSBISupportIndicator;
	...
	public IPSMGWSBISupportIndicatorEnum getIPSMGWSBISupportIndicator()
	{
		if(ipSMGWSBISupportIndicator == null)
			return null;
		
		return ipSMGWSBISupportIndicator.getEnumerated(IPSMGWSBISupportIndicatorEnum.class);
	}
	
	public void setIPSMGWSBISupportIndicator(IPSMGWSBISupportIndicatorEnum value)
	{
		if(value == null)
			this.ipSMGWSBISupportIndicator = null;
		else
			this.ipSMGWSBISupportIndicator = new IPSMGWSBISupportIndicatorImpl(value, null, null);
	}
}