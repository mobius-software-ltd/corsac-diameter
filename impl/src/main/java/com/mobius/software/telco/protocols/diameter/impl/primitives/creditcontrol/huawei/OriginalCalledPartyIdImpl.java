...
*
*/
@DiameterAvpImplementation(code = 20310L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class OriginalCalledPartyIdImpl extends DiameterUTF8StringImpl implements OriginalCalledPartyId
{
	protected OriginalCalledPartyIdImpl()
	{
		super(0, 63);
	}

	public OriginalCalledPartyIdImpl(String value)
	{
		super(value, 0, 63);
	}
}