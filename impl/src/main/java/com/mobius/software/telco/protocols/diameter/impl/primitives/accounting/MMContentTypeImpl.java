...
*
*/
@DiameterAvpImplementation(code = 1203L, vendorId = KnownVendorIDs.TGPP_ID)
public class MMContentTypeImpl implements MMContentType
{
	...
	private List<AdditionalContentInformation> additionalContentInformation;
	...
	public List<AdditionalContentInformation> getAdditionalContentInformation()
	{
		return additionalContentInformation;
	}
	
	public void setAdditionalContentInformation(List<AdditionalContentInformation> value)
	{
		this.additionalContentInformation = value;
	}
}