...
*
*/
@DiameterAvpImplementation(code = 20397L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class MessageContent2Impl extends DiameterUTF8StringImpl implements MessageContent2
{
	protected MessageContent2Impl()
	{
		super(0, 256);
	}

	public MessageContent2Impl(String value)
	{
		super(value, 0, 256);
	}
}