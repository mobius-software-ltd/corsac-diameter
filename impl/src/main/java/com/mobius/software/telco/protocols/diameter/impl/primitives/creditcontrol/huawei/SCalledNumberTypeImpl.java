...
*
*/
@DiameterAvpImplementation(code = 21216L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCalledNumberTypeImpl extends DiameterOctetStringImpl implements SCalledNumberType
{
	protected SCalledNumberTypeImpl()
	{
		super(0, 1);
	}

	public SCalledNumberTypeImpl(ByteBuf value)
	{
		super(value, 0, 1);
	}
}