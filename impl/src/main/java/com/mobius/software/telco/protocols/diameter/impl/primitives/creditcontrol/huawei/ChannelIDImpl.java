...
*
*/
@DiameterAvpImplementation(code = 22347L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ChannelIDImpl extends DiameterUTF8StringImpl implements ChannelID
{
	protected ChannelIDImpl()
	{
		super(0, 32);
	}

	public ChannelIDImpl(String value)
	{
		super(value, 0, 32);
	}
}