...
public class DiameterRulePorts
{
	...
	//required for parser
	public DiameterRulePorts(String value) throws ParseException
	{
		this.value = value;
		parsePorts();
	}
		
	public DiameterRulePorts(Integer port) throws IllegalArgumentException 
	{
	...
	public DiameterRulePorts(Integer min,Integer max) throws IllegalArgumentException 
	{
		if(min<1 || min>65535)
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterRulePorts other = (DiameterRulePorts) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
