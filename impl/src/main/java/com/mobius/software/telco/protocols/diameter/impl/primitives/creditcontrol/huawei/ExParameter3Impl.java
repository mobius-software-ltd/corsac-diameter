...
*
*/
@DiameterAvpImplementation(code = 30314L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class ExParameter3Impl extends DiameterUTF8StringImpl implements ExParameter3
{
	protected ExParameter3Impl()
	{
		super(0,256);
	}

	public ExParameter3Impl(String value)
	{
		super(value, 0, 256);
	}
}