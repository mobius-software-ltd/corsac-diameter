...
public class NtaEventConfigurationClientSessionImpl extends ClientAuthSessionStatelessImpl<EventConfigurationRequest,EventConfigurationAnswer> implements NtaEventConfigurationClientSession
{
	public NtaEventConfigurationClientSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<? extends ClientAuthStatelessListener, ?, ?, ?, ?> provider)
	{
