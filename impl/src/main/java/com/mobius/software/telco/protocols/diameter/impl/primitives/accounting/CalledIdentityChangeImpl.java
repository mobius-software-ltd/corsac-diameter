...
*
*/
@DiameterAvpImplementation(code = 3917L, vendorId = KnownVendorIDs.TGPP_ID)
public class CalledIdentityChangeImpl implements CalledIdentityChange
{
	...
	public CalledIdentityChangeImpl()
	{
	...
	public String getCalledIdentity()
	{
		...
		return calledIdentity.getString();
	}
	
	public void setCalledIdentity(String value)
	{
		if(value==null)
			this.calledIdentity = null;
		else
			this.calledIdentity = new CalledIdentityImpl(value, null, null);			
	}
