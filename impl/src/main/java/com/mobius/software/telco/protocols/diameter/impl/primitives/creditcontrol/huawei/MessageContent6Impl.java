...
*
*/
@DiameterAvpImplementation(code = 20701L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class MessageContent6Impl extends DiameterUTF8StringImpl implements MessageContent6
{
	protected MessageContent6Impl()
	{
		super(0, 256);
	}

	public MessageContent6Impl(String value)
	{
		super(value, 0, 256);
	}
}