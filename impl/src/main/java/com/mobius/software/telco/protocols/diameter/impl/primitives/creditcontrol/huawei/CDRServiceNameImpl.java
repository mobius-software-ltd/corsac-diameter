...
*
*/
@DiameterAvpImplementation(code = 20638L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CDRServiceNameImpl extends DiameterUTF8StringImpl implements CDRServiceName
{
	protected CDRServiceNameImpl()
	{
		super(0, 50);
	}

	public CDRServiceNameImpl(String value)
	{
		super(value, 0, 50);
	}
}