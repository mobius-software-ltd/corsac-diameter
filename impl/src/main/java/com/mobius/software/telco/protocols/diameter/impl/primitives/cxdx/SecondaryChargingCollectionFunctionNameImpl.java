...
public class SecondaryChargingCollectionFunctionNameImpl extends DiameterUriImpl implements SecondaryChargingCollectionFunctionName
{
	...
	protected SecondaryChargingCollectionFunctionNameImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public SecondaryChargingCollectionFunctionNameImpl(String host, Integer port, Boolean isSecure, DiameterTransport transport, DiameterProtocol protocol, Integer minLength, Integer maxLength)
	{
