...
*
*/
@DiameterAvpImplementation(code = 20635L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CDRPkgServiceIdImpl extends DiameterUTF8StringImpl implements CDRPkgServiceId
{
	protected CDRPkgServiceIdImpl()
	{
		super(0, 16);
	}

	public CDRPkgServiceIdImpl(String value)
	{
		super(value, 0, 16);
	}
}