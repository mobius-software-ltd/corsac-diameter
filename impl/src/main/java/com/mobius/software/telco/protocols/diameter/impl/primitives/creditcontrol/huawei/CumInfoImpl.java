...
*
*/
@DiameterAvpImplementation(code = 20853L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class CumInfoImpl implements CumInfo
{
	...
	@Override
	public CumMoney getCumMoney()
	{
		return this.cumMoney;
	}
	
	@Override
	public void setCumMoney(CumMoney value)
	{
		this.cumMoney = value;
	}
	
	@Override
	public ByteBuf getCumId()
	{
		return this.cumId;
	}
	
	@Override
	public void setCumId(ByteBuf value)
	{
		this.cumId = value;
	}
}