...
*
*/
@DiameterAvpImplementation(code = 3841L, vendorId = KnownVendorIDs.TGPP_ID)
public class OSIDImpl extends DiameterOctetStringImpl implements OSID
{
	protected OSIDImpl()
	{
		super();
	...
	protected OSIDImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public OSIDImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
