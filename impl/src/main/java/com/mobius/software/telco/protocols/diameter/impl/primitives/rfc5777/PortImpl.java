...
*
*/
@DiameterAvpImplementation(code = 530L, vendorId = -1L)
public class PortImpl extends DiameterInteger32Impl implements Port
{
	protected PortImpl() 
	{
		super();
	...
	protected PortImpl(Integer minValue,Integer maxValue) 
	{
		super(minValue,maxValue);
	}
	
	public PortImpl(Integer value,Integer minValue,Integer maxValue) 
	{
