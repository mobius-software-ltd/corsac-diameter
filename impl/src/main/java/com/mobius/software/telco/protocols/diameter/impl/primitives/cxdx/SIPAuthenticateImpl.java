...
*
*/
@DiameterAvpImplementation(code = 609L, vendorId = KnownVendorIDs.TGPP_ID)
public class SIPAuthenticateImpl extends DiameterOctetStringImpl implements SIPAuthenticate
{
	...
	protected SIPAuthenticateImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public SIPAuthenticateImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
