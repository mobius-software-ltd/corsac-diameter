...
public class ChargingCharacteristicsSelectionModeImpl extends DiameterEnumeratedImpl<ChargingCharacteristicsSelectionModeEnum> implements ChargingCharacteristicsSelectionMode
{
	...
	protected ChargingCharacteristicsSelectionModeImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}

	public ChargingCharacteristicsSelectionModeImpl(ChargingCharacteristicsSelectionModeEnum value, Integer minValue, Integer maxValue)
	{
