...
*
*/
@DiameterAvpImplementation(code = 640L, vendorId = KnownVendorIDs.TGPP_ID)
public class PathImpl extends DiameterOctetStringImpl implements Path
{
	protected PathImpl()
	{
		super();
	...
	protected PathImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public PathImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
