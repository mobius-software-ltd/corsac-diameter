...
*
*/
public abstract class Pc6AnswerImpl extends VendorSpecificAnswerImpl implements Pc6Answer
{
	protected DRMP drmp;
	...
	protected Pc6AnswerImpl() 
	{
		super();
	}
	
	public Pc6AnswerImpl(String originHost,String originRealm,Boolean isRetransmit, Long resultCode, String sessionID, AuthSessionStateEnum authSessionState) throws MissingAvpException, AvpNotSupportedException
	{
