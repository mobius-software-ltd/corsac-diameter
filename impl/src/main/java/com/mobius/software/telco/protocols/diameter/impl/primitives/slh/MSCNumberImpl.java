...
*
*/
@DiameterAvpImplementation(code = 2403L, vendorId = KnownVendorIDs.TGPP_ID)
public class MSCNumberImpl extends DiameterE164AddressImpl implements MSCNumber
{
	protected MSCNumberImpl()
	{
		super();
	}

	public MSCNumberImpl(String value)
	{
		super(value);
	}
}