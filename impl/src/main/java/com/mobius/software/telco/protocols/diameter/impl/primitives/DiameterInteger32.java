...
public class DiameterInteger32 
{
	...
	//required for parser
	public DiameterInteger32() 
	{
		
	}
	
	public DiameterInteger32(Integer minValue,Integer maxValue) 
	{
		this.minValue = minValue;
		this.maxValue = maxValue;
	}
	
	public DiameterInteger32(Integer value,Integer minValue,Integer maxValue) 
	{
		this.value=value;
		this.minValue = minValue;
		this.maxValue = maxValue;
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterInteger32 other = (DiameterInteger32) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
