...
*
*/
@DiameterAvpImplementation(code = 586L, vendorId = -1L)
public class KeyNameImpl extends DiameterOctetStringImpl implements KeyName
{
	...
	protected KeyNameImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}

	public KeyNameImpl(ByteBuf value, Integer minLength, Integer maxLength)
	{
