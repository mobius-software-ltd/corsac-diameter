...
public class DiameterInteger64 
{
	private Long value;
	...
	//required for parser
	public DiameterInteger64() 
	{
		
	}
	
	public DiameterInteger64(Long minValue,Long maxValue) 
	{
		this.minValue = minValue;
		this.maxValue = maxValue;
	}
	
	public DiameterInteger64(Long value,Long minValue,Long maxValue) 
	{
		this.value=value;
		this.minValue = minValue;
		this.maxValue = maxValue;
	...
	public boolean equals(Object obj) 
	{
		...
		DiameterInteger64 other = (DiameterInteger64) obj;
		if (value == null) 
		{
			if (other.value != null)
				return false;
