...
*
*/
@DiameterCommandImplementation(applicationId = 16777308, commandCode = 320, request = false)
public class DeleteSubscriberDataAnswerImpl extends S7aAnswerImpl implements DeleteSubscriberDataAnswer
{
