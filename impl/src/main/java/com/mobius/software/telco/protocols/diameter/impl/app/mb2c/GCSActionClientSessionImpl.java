...
public class GCSActionClientSessionImpl extends ClientAuthSessionStatelessImpl<GCSActionRequest, GCSActionAnswer> implements GCSActionClientSession
{
	public GCSActionClientSessionImpl(String sessionID, String remoteHost, String remoteRealm, DiameterProvider<? extends ClientAuthStatelessListener, ?, ?, ?, ?> provider)
	{
