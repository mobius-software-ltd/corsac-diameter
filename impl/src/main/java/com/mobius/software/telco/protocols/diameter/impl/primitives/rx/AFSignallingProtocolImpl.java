...
public class AFSignallingProtocolImpl extends DiameterEnumeratedImpl<AFSignallingProtocolEnum> implements AFSignallingProtocol
{
	...
	protected AFSignallingProtocolImpl(Integer minValue, Integer maxValue)
	{
		super(minValue, maxValue);
	}
	
	public AFSignallingProtocolImpl(AFSignallingProtocolEnum value, Integer minValue, Integer maxValue)
	{
