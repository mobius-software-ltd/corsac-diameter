...
*
*/
@DiameterAvpImplementation(code = 21219L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class SCalledHuntingMainNumberImpl extends DiameterOctetStringImpl implements SCalledHuntingMainNumber
{
	protected SCalledHuntingMainNumberImpl()
	{
		super(0, 32);
	}

	public SCalledHuntingMainNumberImpl(ByteBuf value)
	{
		super(value, 0, 32);
	}
}