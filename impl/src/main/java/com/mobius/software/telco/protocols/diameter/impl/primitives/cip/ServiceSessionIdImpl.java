...
public class ServiceSessionIdImpl extends DiameterUTF8StringImpl implements ServiceSessionId
{
	protected ServiceSessionIdImpl()
	{
		super();
	}

	protected ServiceSessionIdImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}
	
	public ServiceSessionIdImpl(String value, Integer minLength, Integer maxLength)
	{
