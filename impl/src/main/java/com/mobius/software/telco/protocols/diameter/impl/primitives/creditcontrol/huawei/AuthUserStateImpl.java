...
*
*/
@DiameterAvpImplementation(code = 30802L, vendorId = KnownVendorIDs.HUAWEI_ID)
public class AuthUserStateImpl extends DiameterUTF8StringImpl implements AuthUserState
{
	protected AuthUserStateImpl()
	{
		super(0, 32);
	}

	public AuthUserStateImpl(String value)
	{
		super(value, 0, 32);
	}
}