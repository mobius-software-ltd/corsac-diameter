...
public class ChargingContextIdImpl extends DiameterUTF8StringImpl implements ChargingContextId
{
	public ChargingContextIdImpl()
	{
		super();
	}

	protected ChargingContextIdImpl(Integer minLength, Integer maxLength)
	{
		super(minLength, maxLength);
	}
	
	public ChargingContextIdImpl(String value, Integer minLength, Integer maxLength)
	{
