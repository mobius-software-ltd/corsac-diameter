...
public class NetworkTestBase
{
	...
	public void setupRemote(Long duplicateTimeout,Long duplicatePeriod) throws Exception
	{
		...
		Class<?> roClazz = com.mobius.software.telco.protocols.diameter.impl.commands.swx.SwxRequestImpl.class;
		...
		serverStack.getNetworkManager().registerApplication(localLinkID, Arrays.asList(new VendorSpecificApplicationId[] {}), Arrays.asList(new Long[] { new Long(ApplicationIDs.SWX) }), Arrays.asList(new Long[] {}), Package.getPackage("com.mobius.software.telco.protocols.diameter.commands.swx"), Package.getPackage("com.mobius.software.telco.protocols.diameter.impl.commands.swx"));
	...
	public void setupLocal(Long duplicateTimeout,Long duplicatePeriod) throws Exception
	{
		...
		//classes area needed to allow proper loading of packages, otherwise compiler may not see them
		@SuppressWarnings("unused")
		Class<?> roClazz = com.mobius.software.telco.protocols.diameter.impl.commands.swx.SwxAnswerImpl.class;
