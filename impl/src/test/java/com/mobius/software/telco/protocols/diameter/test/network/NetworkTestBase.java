...
public class NetworkTestBase
{
	...
	public void setupLocal() throws Exception
	{
		...
		localStack=new DiameterStackImpl(generator, workerPool.getQueue(), workerPool.getPeriodicQueue(), 4, "client.restcomm.org", "Mobius Diameter", 0L, 10L, idleTimeout, responseTimeout, reconnectTimeout, 0L, 0L);
