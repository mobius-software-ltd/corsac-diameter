...
public class NetworkTestBase
{
	...
	protected Long idleTimeout = 5000L;
	...
	public void setupRemote(Long duplicateTimeout,Long duplicatePeriod, Boolean isAnyPort) throws Exception
	{
		...
		Class<?> roClazz = com.mobius.software.telco.protocols.diameter.impl.commands.sy.SpendingStatusNotificationRequestImpl.class;
		...
		serverStack.getNetworkManager().registerApplication(localLinkID, Arrays.asList(new VendorSpecificApplicationId[] {}), Arrays.asList(new Long[] { new Long(ApplicationIDs.SY) }), Arrays.asList(new Long[] {}), Package.getPackage("com.mobius.software.telco.protocols.diameter.commands.sy"), Package.getPackage("com.mobius.software.telco.protocols.diameter.impl.commands.sy"));
