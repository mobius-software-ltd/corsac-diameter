...
public class NetworkTestBase
{
	...
	public void setupRemote(Long duplicateTimeout,Long duplicatePeriod) throws Exception
	{
		...
		Class<?> roClazz = com.mobius.software.telco.protocols.diameter.impl.commands.s13.MEIdentityCheckRequestImpl.class;
		...
		serverStack.getNetworkManager().registerApplication(localLinkID, Arrays.asList(new VendorSpecificApplicationId[] {}), Arrays.asList(new Long[] { new Long(ApplicationIDs.S13) }), Arrays.asList(new Long[] {}), Package.getPackage("com.mobius.software.telco.protocols.diameter.commands.s13"), Package.getPackage("com.mobius.software.telco.protocols.diameter.impl.commands.s13"));
