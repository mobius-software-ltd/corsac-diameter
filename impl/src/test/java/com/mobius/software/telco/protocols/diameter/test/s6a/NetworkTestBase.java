...
public class NetworkTestBase
{
	...
	public void setupRemote(Long duplicateTimeout,Long duplicatePeriod) throws Exception
	{
		...
		Class<?> roClazz = com.mobius.software.telco.protocols.diameter.impl.commands.s6a.S6aRequestImpl.class;
		...
		serverStack.getNetworkManager().registerApplication(localLinkID, Arrays.asList(new VendorSpecificApplicationId[] {}), Arrays.asList(new Long[] { new Long(ApplicationIDs.S6A) }), Arrays.asList(new Long[] {}), Package.getPackage("com.mobius.software.telco.protocols.diameter.commands.s6a"), Package.getPackage("com.mobius.software.telco.protocols.diameter.impl.commands.s6a"));
