...
*
*/
public class CxdxRegistrationTerminationTest extends NetworkTestBase
{
	protected static final String localListenerID = "1";
	private static final Logger logger = LogManager.getLogger(CxdxRegistrationTerminationTest.class);
		...
		serverProvider.setServerListener(listenerID, new ServerListener()
		{
			...
			public void onInitialRequest(CxDxRequest request, ServerAuthSessionStateless<CxDxAnswer> session, String linkID, AsyncCallback callback)
			{
				...
				try
				{
					...
					RegistrationTerminationAnswer rta = serverProvider.getMessageFactory().createRegistrationTerminationAnswer(serverLink.getLocalHost(),serverLink.getLocalRealm(), rtr.getHopByHopIdentifier(), rtr.getEndToEndIdentifier(), ResultCodes.DIAMETER_SUCCESS, rtr.getSessionId());
