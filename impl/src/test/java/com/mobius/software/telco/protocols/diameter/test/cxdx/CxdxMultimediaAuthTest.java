...
*
*/
public class CxdxMultimediaAuthTest extends NetworkTestBase
{
	protected static final String localListenerID = "1";
	private static final Logger logger = LogManager.getLogger(CxdxMultimediaAuthTest.class);
	...
	public void testMultimediaAuth() throws Exception
	{
		...
		serverProvider.setServerListener(listenerID, new ServerListener()
		{
			...
			public void onInitialRequest(CxDxRequest request, ServerAuthSessionStateless<CxDxAnswer> session, String linkID, AsyncCallback callback)
			{
				...
				try
				{
					MultimediaAuthAnswer maa = serverProvider.getMessageFactory().createMultimediaAuthAnswer(mar, mar.getHopByHopIdentifier(), mar.getEndToEndIdentifier(), ResultCodes.DIAMETER_SUCCESS);
		...
		String publicIdentity=new String("publicIdentity"); 
		...
		MultimediaAuthRequest request = provider.getMessageFactory().createMultimediaAuthRequest(localLink.getLocalHost(), localLink.getLocalRealm(), localLink.getDestinationHost(), localLink.getDestinationRealm(),username, publicIdentity,sipNumberAuthItems,sipAuthDataItem,serverName);
	...
	@Test
	public void testDuplicateMultimediaAuth() throws Exception
	{
