...
*
*/
public class SwxPushProfileTest extends NetworkTestBase
{
	protected static final String localListenerID = "1";
	private static final Logger logger = LogManager.getLogger(SwxPushProfileTest.class);
	
	@Test
	public void testSwxPushProfile() throws Exception
	{
