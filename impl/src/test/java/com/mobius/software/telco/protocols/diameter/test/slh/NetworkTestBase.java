...
public class NetworkTestBase
{
	...
	public void setupRemote(Long duplicateTimeout,Long duplicatePeriod) throws Exception
	{
		...
		Class<?> roClazz = com.mobius.software.telco.protocols.diameter.impl.commands.slh.LCSRoutingInfoRequestImpl.class;
		...
		serverStack.getNetworkManager().registerApplication(localLinkID, Arrays.asList(new VendorSpecificApplicationId[] {}), Arrays.asList(new Long[] { new Long(ApplicationIDs.SLH) }), Arrays.asList(new Long[] {}), Package.getPackage("com.mobius.software.telco.protocols.diameter.commands.slh"), Package.getPackage("com.mobius.software.telco.protocols.diameter.impl.commands.slh"));
