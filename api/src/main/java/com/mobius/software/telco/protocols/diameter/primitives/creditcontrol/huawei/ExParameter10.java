 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.EX_PARAMETER_10, vendorId = VendorIDs.HUAWEI_ID, name = "Ex-Parameter-10")
public interface ExParameter10 extends DiameterUTF8String
{
}