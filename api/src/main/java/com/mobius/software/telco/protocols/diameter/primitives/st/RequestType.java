 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.REQUEST_TYPE, vendorId = VendorIDs.TGPP_ID, name = "Request-Type")
public interface RequestType extends DiameterEnumerated<RequestTypeEnum>
{
}