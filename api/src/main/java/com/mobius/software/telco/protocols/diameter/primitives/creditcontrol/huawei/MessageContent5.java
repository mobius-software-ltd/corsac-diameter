 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.MESSAGE_CONTENT_5, vendorId = VendorIDs.HUAWEI_ID, name = "Message-Content-5")
public interface MessageContent5 extends DiameterUTF8String
{
}