 ...
 * 	5.5.7	Trigger-Establishment-Request (TER) Command
	...
	<TE-Request> ::= < Diameter Header: 8388656, REQ, PXY >
				...
				*[ AVP ]
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.S9, commandCode = CommandCodes.TRIGGER_ESTABLIHMENT, request = true, proxyable = true, name="Trigger-Establishment-Request")
