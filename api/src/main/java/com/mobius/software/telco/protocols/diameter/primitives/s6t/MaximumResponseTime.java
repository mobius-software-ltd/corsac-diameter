 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MAXIMUM_RESPONSE_TIME, vendorId = VendorIDs.TGPP_ID, name = "Maximum-Response-Time")
public interface MaximumResponseTime extends DiameterUnsigned32
{
}