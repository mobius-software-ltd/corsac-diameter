 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.READ_REPLY, vendorId = VendorIDs.TGPP_ID, name = "Read-Reply")
public interface ReadReply extends DiameterEnumerated<ReadReplyEnum>
{
}