 ...
 * 	
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.GX, commandCode = CommandCodes.SESSION_TERMINATION, request = true, proxyable = true, name="Session-Termination-Request")
