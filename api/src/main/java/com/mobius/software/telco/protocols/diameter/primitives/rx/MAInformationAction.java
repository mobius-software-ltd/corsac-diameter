 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MA_INFORMATION_ACTION, vendorId = VendorIDs.TGPP_ID, must = false, name = "MA-Information-Action")
public interface MAInformationAction extends DiameterEnumerated<MAInformationActionEnum>
{
}