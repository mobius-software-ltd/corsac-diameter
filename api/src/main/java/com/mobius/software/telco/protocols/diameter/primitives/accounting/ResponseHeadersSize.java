 ...
 */
@DiameterAvpDefinition(code = OneM2MAvpCodes.RESPONSE_HEADER_SIZE, vendorId = VendorIDs.ONEM2M_ID, name = "Response-Headers-Size")
public interface ResponseHeadersSize extends DiameterUnsigned32
{
}