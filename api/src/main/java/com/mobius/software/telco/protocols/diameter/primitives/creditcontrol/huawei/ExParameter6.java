 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.EX_PARAMETER_6, vendorId = VendorIDs.HUAWEI_ID, name = "Ex-Parameter-6")
public interface ExParameter6 extends DiameterUTF8String
{
}