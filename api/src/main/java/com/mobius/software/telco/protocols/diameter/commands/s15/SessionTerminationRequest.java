...
@DiameterCommandDefinition(applicationId = ApplicationIDs.S15, commandCode = CommandCodes.SESSION_TERMINATION, request = true, proxyable = true, name="Session-Termination-Request")
