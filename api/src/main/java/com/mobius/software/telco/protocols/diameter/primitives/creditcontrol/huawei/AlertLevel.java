 ...
 * 	3.2.172  Alert-Level AVP
	...
	Description
	Low balance notification type. The xx variable in the following values indicates the sequence number of the threshold.
    	- 1xx: subscriber-level threshold
