 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.REPORT_CARDINALITY, vendorId = VendorIDs.TGPP_ID, name = "Report-Cardinality")
public interface ReportCardinality extends DiameterEnumerated<ReportCardinalityEnum>
{
}