 ...
 * 	7.3.186	Adjacent-PLMNs
	...
	Adjacent-PLMNs ::= <AVP header: 1672 10415>
			...
			*	[AVP]
 */
@DiameterAvpDefinition(code = TgppAvpCodes.ADJACENT_PLMN, vendorId = VendorIDs.TGPP_ID, must = false, name = "Adjacent-PLMNs")
public interface AdjacentPLMNs extends DiameterGroupedAvp
{
