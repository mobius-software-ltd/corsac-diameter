 ...
 * 	5.3.3.39	IP-SM-GW-SBI-Support-Indicator
	...
	-	SUPPORT_SBI (1).
 */
@DiameterAvpDefinition(code = TgppAvpCodes.IPSMGW_SBI_SUPPORT_INDICATOR, vendorId = VendorIDs.TGPP_ID, must = false, name = "IP-SM-GW-SBI-Support-Indicator")
public interface IPSMGWSBISupportIndicator extends DiameterEnumerated<IPSMGWSBISupportIndicatorEnum>
{
}