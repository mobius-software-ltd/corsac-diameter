...
public enum PeriodicLocationSupportIndicatorEnum implements IntegerEnum
{
	...
	public static PeriodicLocationSupportIndicatorEnum fromInt(Integer value) 
	{
		PeriodicLocationSupportIndicatorEnum type = intToTypeMap.get(value);
	    return type;
	}
	
	private int value;
	
	private PeriodicLocationSupportIndicatorEnum(int value)
	{
		this.value=value;
	}
