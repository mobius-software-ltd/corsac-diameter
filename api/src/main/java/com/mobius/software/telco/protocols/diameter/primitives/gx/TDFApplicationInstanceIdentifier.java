 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.TDF_APPLICATION_INSTANCE_IDENTIFIER, vendorId = VendorIDs.TGPP_ID, must = false, name = "TDF-Application-Instance-Identifier")
