 ...
 */
public enum ProtocolEnum implements IntegerEnum
{
	OPOPT(0),ICMP(1),IGMP(2),GGP(3),IPv4(4),ST(5),TCP(6),
	...
	private static final Map<Integer, ProtocolEnum> intToTypeMap = new HashMap<Integer, ProtocolEnum>();
	static
	{
	...
	public static ProtocolEnum fromInt(Integer value) 
	{
		ProtocolEnum type = intToTypeMap.get(value);
	    return type;
	}
