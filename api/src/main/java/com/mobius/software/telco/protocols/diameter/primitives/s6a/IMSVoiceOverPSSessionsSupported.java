 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.IMS_VOICE_OVER_PS_SESSIONS_SUPPORTED, vendorId = VendorIDs.TGPP_ID, must = false, name = "IMS-Voice-Over-PS-Sessions-Supported")
