 ...
 * 	7.2.127	Originator-Received-Address AVP
	...
	Originator-Received-Address :: = < AVP Header: 2027>
		...
		[ Address-Domain ]
 */
@DiameterAvpDefinition(code = TgppAvpCodes.ORIGINATOR_RECEIVED_ADDRESS, vendorId = VendorIDs.TGPP_ID, name = "Originator-Received-Address")
public interface OriginatorReceivedAddress extends DiameterAvp
{
