 ...
 */
public enum CreditControlFailureHandlingEnum implements IntegerEnum
{
	TERMINATE(0),CONTINUE(1),RETRY_AND_TERMINATE(2);

	private static final Map<Integer, CreditControlFailureHandlingEnum> intToTypeMap = new HashMap<Integer, CreditControlFailureHandlingEnum>();
	static 
	{
	    for (CreditControlFailureHandlingEnum type : CreditControlFailureHandlingEnum.values()) 
	    {
	    	intToTypeMap.put(type.value, type);
	    }
	}

	public static CreditControlFailureHandlingEnum fromInt(Integer value) 
	{
		CreditControlFailureHandlingEnum type = intToTypeMap.get(value);
	    return type;
	}
	
	private int value;
	
	private CreditControlFailureHandlingEnum(int value)
	{
		this.value=value;
	}
