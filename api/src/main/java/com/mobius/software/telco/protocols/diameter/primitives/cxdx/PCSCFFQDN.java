 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.PCSCF_FQDN, vendorId = VendorIDs.TGPP_ID, must = false, name = "PCSCF-FQDN")
public interface PCSCFFQDN extends DiameterIdentity
{
}