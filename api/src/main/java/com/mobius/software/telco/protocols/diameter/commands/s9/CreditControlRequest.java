 ...
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.S9, commandCode = CommandCodes.CREDIT_CONTROL, request = true, proxyable = true, name="Credit-Control-Request")
