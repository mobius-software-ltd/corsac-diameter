 ...
 * 	
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.S9ATAG, commandCode = CommandCodes.SESSION_TERMINATION, request = true, proxyable = true, name="Session-Termination-Request")
