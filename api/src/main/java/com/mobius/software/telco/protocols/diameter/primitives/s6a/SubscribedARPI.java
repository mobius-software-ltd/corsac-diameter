 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.SUBSCRIBED_ARPI, vendorId = VendorIDs.TGPP_ID, must = false, name = "Subscribed-ARPI")
public interface SubscribedARPI extends DiameterUnsigned32
{
}