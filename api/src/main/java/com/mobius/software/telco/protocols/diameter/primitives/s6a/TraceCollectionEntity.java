 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.TRACE_COLLECTIVITY_ENTITY, vendorId = VendorIDs.TGPP_ID, name = "Trace-Collection-Entity")
public interface TraceCollectionEntity extends DiameterAddress
{
}