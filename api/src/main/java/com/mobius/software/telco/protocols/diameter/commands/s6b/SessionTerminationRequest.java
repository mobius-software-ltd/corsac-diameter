 ...
 * 	9.2.2.3.1	Session-Termination-Request (STR) Command
	...
	<Session-Termination-Request> ::=	< Diameter Header: 275, REQ, PXY, 16777272 >
			...
			*[ AVP ]			
 */
@DiameterCommandDefinition(applicationId = 16777272, commandCode = 275, request = true, proxyable = true, name="Session-Termination-Request")
public interface SessionTerminationRequest extends S6bRequest
{
