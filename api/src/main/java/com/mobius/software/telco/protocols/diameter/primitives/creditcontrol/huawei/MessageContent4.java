 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.MESSAGE_CONTENT_4, vendorId = VendorIDs.HUAWEI_ID, name = "Message-Content-4")
public interface MessageContent4 extends DiameterUTF8String
{
}