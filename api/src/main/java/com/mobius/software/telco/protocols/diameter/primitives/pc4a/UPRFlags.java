...
/*
	6.3.6	UPR-Flags	
	The UPR-Flags AVP is of type Unsigned32 and it shall contain a bit mask. The meaning of the bits is defined in table 6.3.6-1:
 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.UPR_FLAGS, vendorId = VendorIDs.TGPP_ID, name = "UPR-Flags")
