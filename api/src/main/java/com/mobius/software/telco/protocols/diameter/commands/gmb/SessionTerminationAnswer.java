 ...
 * 	17.6.4	STA Command
	...
	<ST-Answer>  ::= < Diameter Header: 275, PXY >
                      ...
                      *	[ Proxy-Info ]
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.GMB, commandCode = CommandCodes.SESSION_TERMINATION, request = false, proxyable = true, name="Session-Termination-Answer")
