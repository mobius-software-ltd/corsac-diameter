 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MAX_REQUESTED_BANDWIDTH_DL, vendorId = VendorIDs.TGPP_ID, name = "Max-Requested-Bandwidth-DL")
public interface MaxRequestedBandwidthDL extends DiameterUnsigned32
{
}