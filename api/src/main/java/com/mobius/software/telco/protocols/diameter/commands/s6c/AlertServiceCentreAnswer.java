 ...
 * 	5.3.2.6	Alert-Service-Centre-Answer (ALA) Command
	...
	< Alert-Service-Centre-Answer > ::=	< Diameter Header: 8388648, PXY, 16777312 >
				...
				*[ Route-Record ]
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.S6C, commandCode = CommandCodes.ALERT_SERVICE_CENTRE, request = false, proxyable = true, name="Alert-Service-Centre-Answer")
public interface AlertServiceCentreAnswer extends S6cAnswer
{	
}