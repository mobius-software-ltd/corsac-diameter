 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.OPERATING_CHANNEL, vendorId = VendorIDs.TGPP_ID, name = "Operating-Channel")
public interface OperatingChannel extends DiameterUnsigned32
{
}