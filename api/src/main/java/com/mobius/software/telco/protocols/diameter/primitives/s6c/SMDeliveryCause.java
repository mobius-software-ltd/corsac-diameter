 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.SM_DELIVERY_CAUSE, vendorId = VendorIDs.TGPP_ID, name = "SM-Delivery-Cause")
public interface SMDeliveryCause extends DiameterEnumerated<SMDeliveryCauseEnum>
{
}