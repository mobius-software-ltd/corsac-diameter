 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MONITORING_KEY, vendorId = VendorIDs.TGPP_ID, must = false, name = "Monitoring-Key")
public interface MonitoringKey extends DiameterOctetString
{
}