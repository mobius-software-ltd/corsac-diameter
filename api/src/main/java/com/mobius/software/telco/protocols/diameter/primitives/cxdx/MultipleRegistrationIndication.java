 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MULTIPLE_REGISTRATION_INDICATION, vendorId = VendorIDs.TGPP_ID, must = false, name = "Multiple-Registration-Indication")
public interface MultipleRegistrationIndication extends DiameterEnumerated<MultipleRegistrationIndicationEnum>
{
}