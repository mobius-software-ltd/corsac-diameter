 ...
 * 	7.2.154aA Privacy-Indicator AVP
	...
	1 PRIVATE 
 */
@DiameterAvpDefinition(code = TgppAvpCodes.PRIVACY_INDICATOR, vendorId = VendorIDs.TGPP_ID, name = "Privacy-Indicator")
public interface PrivacyIndicator extends DiameterEnumerated<PrivacyIndicatorEnum>
{
}