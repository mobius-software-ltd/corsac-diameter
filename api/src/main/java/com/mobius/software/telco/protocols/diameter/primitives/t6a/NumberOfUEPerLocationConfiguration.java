 ...
 * 	6.4.11	Number-Of-UE-Per-Location-Configuration
	...
	Number-of-UE-Per-Location-Configuration ::= <AVP header: 4306 10415>
			...
			*[AVP]
 */
@DiameterAvpDefinition(code = TgppAvpCodes.NUMBER_OF_UE_PER_LOCATION_CONFIGURATION, vendorId = VendorIDs.TGPP_ID, name = "Number-Of-UE-Per-Location-Configuration")
