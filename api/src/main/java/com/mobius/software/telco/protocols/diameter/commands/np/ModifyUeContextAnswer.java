 ...
 * 	5.6.6	Modify-Uecontext-Answer (MUA) command
	...
	< Modify-Uecontext‑Answer > ::= < Diameter Header: 8388722, PXY >
                ...
                *[ AVP ]
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.NP, commandCode = CommandCodes.MODIFY_UE_CONTEXT, request = false, proxyable = true, name="Modify-Uecontext‑Answer")
