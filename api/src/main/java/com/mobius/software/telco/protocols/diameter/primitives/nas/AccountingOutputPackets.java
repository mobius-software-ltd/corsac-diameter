 ...
 */
@DiameterAvpDefinition(code = AvpCodes.ACCOUNTING_OUTPUT_PACKETS, vendorId = -1L, name = "Accounting-Output-Packets")
public interface AccountingOutputPackets extends DiameterUnsigned64
{
}