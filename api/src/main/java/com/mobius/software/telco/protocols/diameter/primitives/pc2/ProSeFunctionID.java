 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.PROSE_FUNCTION_ID, vendorId = VendorIDs.TGPP_ID, name = "ProSe-Function-ID")
public interface ProSeFunctionID extends DiameterOctetString
{
}