...
/*
	...
	3261 [11].
 */
@DiameterAvpDefinition(code = TgppAvpCodes.TO_SIP_HEADER, vendorId = VendorIDs.TGPP_ID, must = false, name = "To-SIP-Header")
public interface ToSIPHeader extends DiameterOctetString
{
}