 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.SMSF_3GPP_ABSCENT_USER_DIAGNOSTIC_SM, vendorId = VendorIDs.TGPP_ID, must = false, name = "SMSF-3GPP-Absent-User-Diagnostic-SM")
