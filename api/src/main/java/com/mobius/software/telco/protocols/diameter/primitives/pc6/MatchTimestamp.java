 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MATCH_TIMESTAMP, vendorId = VendorIDs.TGPP_ID, must = false, name = "Match-Timestamp")
public interface MatchTimestamp extends DiameterTime
{
}