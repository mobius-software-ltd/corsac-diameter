 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.EX_PARAMETER_3, vendorId = VendorIDs.HUAWEI_ID, name = "Ex-Parameter-3")
public interface ExParameter3 extends DiameterUTF8String
{
}