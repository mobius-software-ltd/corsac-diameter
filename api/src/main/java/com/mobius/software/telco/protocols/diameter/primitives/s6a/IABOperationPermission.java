 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.IAB_OPERATION_PERMISSION, vendorId = VendorIDs.TGPP_ID, must = false, name = "IAB-Operation-Permission")
public interface IABOperationPermission extends DiameterEnumerated<IABOperationPermissionEnum>
{
}