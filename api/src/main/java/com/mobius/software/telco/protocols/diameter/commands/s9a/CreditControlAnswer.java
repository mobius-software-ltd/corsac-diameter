 ...
 *  A.7.6.3	CC-Answer (CCA) Command
	...
	<CC-Answer> ::=  < Diameter Header: 272, PXY >
               ...
               *[ AVP ]
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.S9A, commandCode = CommandCodes.CREDIT_CONTROL, request = false, proxyable = true, name="Credit-Control-Answer")
