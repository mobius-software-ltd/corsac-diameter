 ...
 * 	6.3.3	Assistance-info
	...
	Assistance-Info ::=	<AVP header: 3802 10415>
		...
		*[AVP]
 */
@DiameterAvpDefinition(code = TgppAvpCodes.ASSISTANCE_INFO, vendorId = VendorIDs.TGPP_ID, name = "Assistance-info")
public interface AssistanceInfo extends DiameterGroupedAvp
{
	WLANAssistanceInfo getWLANAssistanceInfo();
	
	void setWLANAssistanceInfo(WLANAssistanceInfo value);
}