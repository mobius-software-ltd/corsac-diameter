 ...
 * 	20.4.4		Session-Termination-Answer Command
	...
	<ST-Answer>  ::= < Diameter Header: 275, PXY >
                      ...
                      *	[ Proxy-Info ]
                       	[ Restart-Counter ]
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.SGMB, commandCode = CommandCodes.SESSION_TERMINATION, request = false, proxyable = true, name="Session-Termination-Answer")
