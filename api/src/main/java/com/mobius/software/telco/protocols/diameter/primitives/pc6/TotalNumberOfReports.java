 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.TOTAL_NUMBER_OF_REPORTS, vendorId = VendorIDs.TGPP_ID, name = "Total-Number-Of-Reports")
public interface TotalNumberOfReports extends DiameterUnsigned32
{
}