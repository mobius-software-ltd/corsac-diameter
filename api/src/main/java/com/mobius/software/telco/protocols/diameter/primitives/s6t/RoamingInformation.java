 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.ROAMING_INFORMATION, vendorId = VendorIDs.TGPP_ID, name = "Roaming-Information")
public interface RoamingInformation extends DiameterEnumerated<RoamingInformationEnum>
{
}