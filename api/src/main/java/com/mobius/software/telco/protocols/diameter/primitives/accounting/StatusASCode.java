 ...
 * 	7.2.215A Status-AS-Code AVP
	...
	2 Timeout 
 */
@DiameterAvpDefinition(code = TgppAvpCodes.STATUS_AS_CODE, vendorId = VendorIDs.TGPP_ID, name = "Status-AS-Code")
public interface StatusASCode extends DiameterEnumerated<StatusASCodeEnum>
{
}