...
@DiameterCommandDefinition(applicationId = ApplicationIDs.S15, commandCode = CommandCodes.SESSION_TERMINATION, request = false, proxyable = true, name="Session-Termination-Answer")
