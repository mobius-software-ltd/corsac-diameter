 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MIN_DESIRED_BANDWIDTH_DL, vendorId = VendorIDs.TGPP_ID, must = false, name = "Min-Desired-Bandwidth-DL")
public interface MinDesiredBandwidthDL extends DiameterUnsigned32
{
}