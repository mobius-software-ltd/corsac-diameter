...
/*
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.GX, commandCode = CommandCodes.ABORT_SESSION, request = false, proxyable = true, name="Abort-Session-Answer")
