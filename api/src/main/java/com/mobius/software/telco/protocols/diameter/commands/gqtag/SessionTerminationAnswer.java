 ...
 * 	7.1.6 Session-Termination-Answer (STA) command
	...
	<ST-Answer> ::= < Diameter Header: 275, PXY >
			 ...
			 *[ Proxy-Info ]
			  [ AVP ] 
*/
@DiameterCommandDefinition(applicationId = 16777222, commandCode = 275, request = false, proxyable = true, name="Session-Termination-Answer")
public interface SessionTerminationAnswer extends com.mobius.software.telco.protocols.diameter.commands.gq.SessionTerminationAnswer
{
}