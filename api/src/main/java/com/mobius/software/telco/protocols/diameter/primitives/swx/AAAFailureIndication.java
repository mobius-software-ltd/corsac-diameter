 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.AAA_FAILURE_INDICATION, vendorId = VendorIDs.TGPP_ID, must = false, name = "AAA-Failure-Indication")
public interface AAAFailureIndication extends DiameterUnsigned32
{
}