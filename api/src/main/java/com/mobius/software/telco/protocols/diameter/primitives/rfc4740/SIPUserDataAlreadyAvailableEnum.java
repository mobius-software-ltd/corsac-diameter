 ...
 */
public enum SIPUserDataAlreadyAvailableEnum implements IntegerEnum
{
	USER_DATA_NOT_AVAILABLE(0),USER_DATA_ALREADY_AVAILABLE(1);

	private static final Map<Integer, SIPUserDataAlreadyAvailableEnum> intToTypeMap = new HashMap<Integer, SIPUserDataAlreadyAvailableEnum>();
	static
	{
	    for (SIPUserDataAlreadyAvailableEnum type : SIPUserDataAlreadyAvailableEnum.values()) 
	    {
	    	intToTypeMap.put(type.value, type);
	    }
	}

	public static SIPUserDataAlreadyAvailableEnum fromInt(Integer value) 
	{
		SIPUserDataAlreadyAvailableEnum type = intToTypeMap.get(value);
	    return type;
	}
	
	private int value;
	
	private SIPUserDataAlreadyAvailableEnum(int value)
	{
		this.value=value;
	}
