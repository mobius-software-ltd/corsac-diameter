 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MPS_IDENTIFIER, vendorId = VendorIDs.TGPP_ID, must = false, name = "MPS-Identifier")
public interface MPSIdentifier extends DiameterOctetString
{
}