 ...
 * 	9.4.  SIP-Server-Assignment-Type AVP
   	...
   	o  	DEREGISTRATION_TOO_MUCH_DATA (11)
      	...
      	can accept.
 */
public enum SIPServerAssignmentTypeEnum implements IntegerEnum
{
	...
	AUTHENTICATION_FAILURE(9),AUTHENTICATION_TIMEOUT(10),DEREGISTRATION_TOO_MUCH_DATA(11);

	private static final Map<Integer, SIPServerAssignmentTypeEnum> intToTypeMap = new HashMap<Integer, SIPServerAssignmentTypeEnum>();
	static
	{
	    for (SIPServerAssignmentTypeEnum type : SIPServerAssignmentTypeEnum.values()) 
	    {
	    	intToTypeMap.put(type.value, type);
	    }
	}

	public static SIPServerAssignmentTypeEnum fromInt(Integer value) 
	{
		SIPServerAssignmentTypeEnum type = intToTypeMap.get(value);
	    return type;
	}
	
	private int value;
	
	private SIPServerAssignmentTypeEnum(int value)
	{
		this.value=value;
	}
