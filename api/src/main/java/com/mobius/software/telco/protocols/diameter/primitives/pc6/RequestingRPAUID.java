 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.REQUESTING_RPAUID, vendorId = VendorIDs.TGPP_ID, must = false, name = "Requesting-RPAUID")
public interface RequestingRPAUID extends DiameterUTF8String
{
}