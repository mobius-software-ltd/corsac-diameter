 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.IPSMGW_REALM, vendorId = VendorIDs.TGPP_ID, name = "IP-SM-GW-Realm")
public interface IPSMGWRealm extends DiameterIdentity
{
}