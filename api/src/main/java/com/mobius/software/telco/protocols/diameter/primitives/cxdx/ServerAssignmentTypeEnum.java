 ...
 * 	6.3.15	Server-Assignment-Type AVP
	...
	RESTORATION (14)
    	• 	Used in the SWx protocol, defined in 3GPP TS 29.273 [18]. This value is not used in the Cx protocol.
 */
public enum ServerAssignmentTypeEnum implements IntegerEnum
{
	NO_ASSIGNMENT(0),REGISTRATION(1),RE_REGISTRATION(2),UNREGISTERED_USER(3),TIMEOUT_DEREGISTRATION(4),USER_DEREGISTRATION(5),
	TIMEOUT_DEREGISTRATION_STORE_SERVER_NAME(6),USER_DEREGISTRATION_STORE_SERVER_NAME(7),ADMINISTRATIVE_DEREGISTRATION(8),
	AUTHENTICATION_FAILURE(9),AUTHENTICATION_TIMEOUT(10),DEREGISTRATION_TOO_MUCH_DATA(11),AAA_USER_DATA_REQUEST(12),
	PGW_UPDATE(13),RESTORATION(14);

	private static final Map<Integer, ServerAssignmentTypeEnum> intToTypeMap = new HashMap<Integer, ServerAssignmentTypeEnum>();
	static
	{
	    for (ServerAssignmentTypeEnum type : ServerAssignmentTypeEnum.values()) 
	    {
	    	intToTypeMap.put(type.value, type);
	    }
	}

	public static ServerAssignmentTypeEnum fromInt(Integer value) 
	{
		ServerAssignmentTypeEnum type = intToTypeMap.get(value);
	    return type;
	}
	
	private int value;
	
	private ServerAssignmentTypeEnum(int value)
	{
		this.value=value;
	}
