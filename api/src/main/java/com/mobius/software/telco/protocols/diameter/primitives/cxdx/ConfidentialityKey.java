 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.CONFIDENTIALITY_KEY, vendorId = VendorIDs.TGPP_ID, name = "Confidentiality-Key")
public interface ConfidentialityKey extends DiameterOctetString
{
}