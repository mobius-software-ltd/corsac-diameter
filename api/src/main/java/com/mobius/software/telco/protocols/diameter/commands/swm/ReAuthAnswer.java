 ...
 * 	7.2.2.4.2	Re-Auth-Answer (RAA) Command
	...
	< Re-Auth-Answer > ::=	< Diameter Header: 258, PXY, 16777264 >
			...
			*[ AVP ]
 */
@DiameterCommandDefinition(applicationId = 16777264, commandCode = 258, request = false, proxyable = true, name="Re-Auth-Answer")
public interface ReAuthAnswer extends SwmAnswer
{	
}