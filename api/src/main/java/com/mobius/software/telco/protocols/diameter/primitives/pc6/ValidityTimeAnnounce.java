 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.VALIDITY_TIME_ANNOUNCE, vendorId = VendorIDs.TGPP_ID, name = "Validity-Time-Announce")
public interface ValidityTimeAnnounce extends DiameterUnsigned32
{
}