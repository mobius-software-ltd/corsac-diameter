 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.SMSF_NON_3GPP_SM_DELIVERY_OUTCOME, vendorId = VendorIDs.TGPP_ID, must = false, name = "SMSF-Non-3GPP-SM-Delivery-Outcome")
