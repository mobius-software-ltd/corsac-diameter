 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.EX_PARAMETER_9, vendorId = VendorIDs.HUAWEI_ID, name = "Ex-Parameter-9")
public interface ExParameter9 extends DiameterUTF8String
{
}