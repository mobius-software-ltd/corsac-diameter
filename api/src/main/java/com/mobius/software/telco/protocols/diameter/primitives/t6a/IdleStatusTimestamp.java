 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.IDLE_STATUS_TIMESTAMP, vendorId = VendorIDs.TGPP_ID,must = false, name = "Idle-Status-Timestamp")
public interface IdleStatusTimestamp extends DiameterTime
{
}