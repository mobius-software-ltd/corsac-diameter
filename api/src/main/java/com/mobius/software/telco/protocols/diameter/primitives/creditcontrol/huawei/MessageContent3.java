 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.MESSAGE_CONTENT_3, vendorId = VendorIDs.HUAWEI_ID, name = "Message-Content-3")
public interface MessageContent3 extends DiameterUTF8String
{
}