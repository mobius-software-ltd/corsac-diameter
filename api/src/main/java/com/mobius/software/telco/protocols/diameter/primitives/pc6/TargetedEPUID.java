 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.TARGETED_EPUID, vendorId = VendorIDs.TGPP_ID, name = "Targeted-EPUID")
public interface TargetedEPUID extends DiameterUTF8String
{
}