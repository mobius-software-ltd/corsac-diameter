 ...
 */
@DiameterAvpDefinition(code = AvpCodes.MIP_MAC_MOBILITY_DATA, vendorId = -1L, name = "MIP-MAC-Mobility-Data")
public interface MIPMACMobilityData extends DiameterOctetString
{
}