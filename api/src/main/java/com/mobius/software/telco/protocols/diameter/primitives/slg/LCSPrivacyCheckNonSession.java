 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.LCS_PRIVACY_CHECK_NON_SESSION, vendorId = VendorIDs.TGPP_ID, name = "LCS-Privacy-Check-Non-Session")
public interface LCSPrivacyCheckNonSession extends DiameterAvp
{
