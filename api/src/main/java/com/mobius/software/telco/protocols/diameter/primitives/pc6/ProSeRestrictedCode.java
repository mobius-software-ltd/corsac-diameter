 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.PROSE_RESTRICTED_CODE, vendorId = VendorIDs.TGPP_ID, must = false, name = "ProSe-Restricted-Code")
public interface ProSeRestrictedCode extends DiameterOctetString
{
}