 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.RS_BANDWIDTH, vendorId = VendorIDs.TGPP_ID, name = "RS-Bandwidth")
public interface RSBandwidth extends DiameterUnsigned32
{
}