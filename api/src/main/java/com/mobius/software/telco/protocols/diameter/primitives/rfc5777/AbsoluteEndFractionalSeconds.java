 ...
 */
@DiameterAvpDefinition(code = AvpCodes.ABSOLUTE_END_FRACTIONAL_SECONDS, vendorId = -1L, name = "Absolute-End-Fractional-Seconds")
public interface AbsoluteEndFractionalSeconds extends DiameterUnsigned32
{
}