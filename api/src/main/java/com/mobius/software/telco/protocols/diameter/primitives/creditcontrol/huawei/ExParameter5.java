 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.EX_PARAMETER_5, vendorId = VendorIDs.HUAWEI_ID, name = "Ex-Parameter-5")
public interface ExParameter5 extends DiameterUTF8String
{
}