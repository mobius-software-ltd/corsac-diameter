 ...
 * 	5.3.19	Media-Type AVP
	...
	-	OTHER (0xFFFFFFFF)
 */
public enum MediaTypeEnum implements IntegerEnum
{
	AUDIO(0),VIDEO(1),DATA(2),APPLICATION(3),CONTROL(4),TEXT(5),MESSAGE(6),OTHER(0xFFFFFFFF);

	private static final Map<Integer, MediaTypeEnum> intToTypeMap = new HashMap<Integer, MediaTypeEnum>();
	static
	{
	...
	public static MediaTypeEnum fromInt(Integer value) 
	{
		MediaTypeEnum type = intToTypeMap.get(value);
	    return type;
	}
