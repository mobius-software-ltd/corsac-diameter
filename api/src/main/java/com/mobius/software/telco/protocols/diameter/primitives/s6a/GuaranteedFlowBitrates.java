 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.GUARANTEED_FLOW_BITRATES, vendorId = VendorIDs.TGPP_ID, must = false, name = "Guaranteed-Flow-Bitrates")
public interface GuaranteedFlowBitrates extends DiameterInteger32
{
}