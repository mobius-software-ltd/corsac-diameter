 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.TARGET_RPAUID, vendorId = VendorIDs.TGPP_ID, must = false, name = "Target-RPAUID")
public interface TargetRPAUID extends DiameterUTF8String
{
}