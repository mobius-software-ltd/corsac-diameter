...
public interface SessionFactory
{
	...
	public NtaEventConfigurationServerSession createServerSession(EventConfigurationAnswer request) throws AvpNotSupportedException;	
	
	public NtaEventReportingClientSession createServerSession(EventReportingRequest request) throws AvpNotSupportedException;
	
	public NtaEventReportingServerSession createServerSession(EventReportingAnswer request) throws AvpNotSupportedException;	
}