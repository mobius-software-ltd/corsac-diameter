 ...
 * 	6.2.11	ProSe-Initial-Location-Information-Request (PSR) Command
	The ProSe-Initial-Location-Information-Request (PSR) command, indicated by the Command-Code field set to 8388713 and the "R" bit set in the Command Flags field, is sent from the ProSe Function to the HSS. 
	Message Format
