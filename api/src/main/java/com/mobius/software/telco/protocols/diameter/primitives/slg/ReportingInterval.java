 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.REPORTING_INTERVAL, vendorId = VendorIDs.TGPP_ID, must = false, name = "Reporting-Interval")
public interface ReportingInterval extends DiameterUnsigned32
{
}