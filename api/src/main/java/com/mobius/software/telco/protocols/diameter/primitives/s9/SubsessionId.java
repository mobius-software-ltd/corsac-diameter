 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.SUBSESSION_ID, vendorId = VendorIDs.TGPP_ID, name = "Subsession-Id")
public interface SubsessionId extends DiameterUnsigned32
{
}