 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.CIA_FLAGS, vendorId = VendorIDs.TGPP_ID,must = false, name = "CIA-Flags")
public interface CIAFlags extends DiameterBitmask32
{
