 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.MESSAGE_CONTENT_6, vendorId = VendorIDs.HUAWEI_ID, name = "Message-Content-6")
public interface MessageContent6 extends DiameterUTF8String
{
}