...
public interface AuthenticationInfo extends DiameterGroupedAvp
{
	...
	void setEUTRANVector(List<EUTRANVector> value);	
	
	List<UTRANVector> getUTRANVector();
	
	void setUTRANVector(List<UTRANVector> value);	
	
	List<GERANVector> getGERANVector();
	
	void setGERANVector(List<GERANVector> value);	
}