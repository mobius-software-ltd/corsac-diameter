 ...
 * 	6.2.5	Reporting-Information-Request (RIR) Command
	...
	< Reporting-Information-Request > ::=	< Diameter Header: 8388719, REQ, PXY, 16777346 >
			...
			*[AVP]
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.T6A, commandCode = CommandCodes.REPORTING_INFORMATION, request = true, proxyable = true, name="Reporting-Information-Request")
