 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.PREPADING_SUPPORT, vendorId = VendorIDs.TGPP_ID, must = false, name = "Pre-Paging-Supported")
public interface PrePagingSupported extends DiameterEnumerated<PrePagingSupportedEnum>
{
}