 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.EXTENDED_MAX_SUPPORTED_BW_DL, vendorId = VendorIDs.TGPP_ID, must = false, name = "Extended-Max-Supported-BW-DL")
public interface ExtendedMaxSupportedBWDL extends DiameterUnsigned32
{
}