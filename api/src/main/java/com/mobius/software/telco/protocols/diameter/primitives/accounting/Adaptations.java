 ...
 * 	7.2.4 Adaptations AVP
	...
	1 No 
 */
@DiameterAvpDefinition(code = TgppAvpCodes.ADAPTATIONS, vendorId = VendorIDs.TGPP_ID, name = "Adaptations")
public interface Adaptations extends DiameterEnumerated<AdaptationsEnum>
{
}