 ...
 */
@DiameterAvpDefinition(code = EtsiAvpCodes.PORT_NUMBER, vendorId = VendorIDs.ETSI_ID, must = false, name = "Port-Number")
public interface PortNumber extends DiameterUnsigned32
{
}