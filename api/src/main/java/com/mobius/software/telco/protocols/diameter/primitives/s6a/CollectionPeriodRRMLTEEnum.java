 ...
 */
public enum CollectionPeriodRRMLTEEnum implements IntegerEnum
{
	MS_1024(0),MS_1280(1),MS_2048(2),MS_2560(3),MS_5120(4),MS_10240(5),MIN_1(6);

	private static final Map<Integer, CollectionPeriodRRMLTEEnum> intToTypeMap = new HashMap<Integer, CollectionPeriodRRMLTEEnum>();
	static
	{
	    for (CollectionPeriodRRMLTEEnum type : CollectionPeriodRRMLTEEnum.values()) 
	    {
	    	intToTypeMap.put(type.value, type);
	    }
	}

	public static CollectionPeriodRRMLTEEnum fromInt(Integer value) 
	{
		CollectionPeriodRRMLTEEnum type = intToTypeMap.get(value);
	    return type;
	}
	
	private int value;
	
	private CollectionPeriodRRMLTEEnum(int value)
	{
		this.value=value;
	}
