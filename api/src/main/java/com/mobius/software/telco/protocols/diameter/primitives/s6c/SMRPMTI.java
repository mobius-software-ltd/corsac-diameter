 ...
 * 	5.3.3.2	SM-RP-MTI
	...
	-	SM_STATUS_REPORT (1)  
 */
@DiameterAvpDefinition(code = TgppAvpCodes.SM_RP_MTI, vendorId = VendorIDs.TGPP_ID, name = "SM-RP-MTI")
public interface SMRPMTI extends DiameterEnumerated<SMRPMTIEnum>
{
}