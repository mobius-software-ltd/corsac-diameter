 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.OLD_REFERENCE_NUMBER, vendorId = VendorIDs.TGPP_ID, must = false, name = "Old-Reference-Number")
public interface OldReferenceNumber extends DiameterUnsigned32
{
}