 ...
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.SD, commandCode = CommandCodes.CREDIT_CONTROL, request = false, proxyable = true, name="Credit-Control-Answer")
