...
/*
  ...
  Bit      Name           Description
   ...
   0     Final report   This bit, when set, 
                       indicates that this is the final report 
                       for the UE group; when not set, 
                       indicates that there are more reports pending for the UE group.
*/

@DiameterAvpDefinition(code = TgppAvpCodes.EVENT_CONFIGURATION_STATE, vendorId = VendorIDs.TGPP_ID, name = "Event-Configuration-State")
public interface EventConfigurationState extends DiameterUnsigned32
{
