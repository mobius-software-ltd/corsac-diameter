 ...
 * 	7.4.50	Periodic-Location-Support-Indicator
	...
	SUPPORTED (1)
 */
@DiameterAvpDefinition(code = TgppAvpCodes.PERIODIC_LOCATION_SUPPORT_INDICATOR, vendorId = VendorIDs.TGPP_ID, must = false, name = "Periodic-Location-Support-Indicator")
public interface PeriodicLocationSupportIndicator extends DiameterEnumerated<PeriodicLocationSupportIndicatorEnum>
{
}