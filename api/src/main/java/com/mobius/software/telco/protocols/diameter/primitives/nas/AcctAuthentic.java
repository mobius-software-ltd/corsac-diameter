 ...
 */
@DiameterAvpDefinition(code = AvpCodes.ACCT_AUTHENTIC, vendorId = -1L, name = "Acct-Authentic")
public interface AcctAuthentic extends DiameterEnumerated<AcctAuthenticEnum>
{
}