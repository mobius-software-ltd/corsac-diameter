 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.RELAY_NODE_INDICATOR, vendorId = VendorIDs.TGPP_ID, must = false, name = "Relay-Node-Indicator")
public interface RelayNodeIndicator extends DiameterEnumerated<RelayNodeIndicatorEnum>
{
}