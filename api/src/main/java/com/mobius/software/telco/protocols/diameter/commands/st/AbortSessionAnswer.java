...
/*
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.ST, commandCode = CommandCodes.ABORT_SESSION, request = false, proxyable = true, name="Abort-Session-Answer")
