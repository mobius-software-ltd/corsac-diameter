 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MONTE_LOCATION_TYPE, vendorId = VendorIDs.TGPP_ID, name = "MONTE-Location-Type")
public interface MONTELocationType extends DiameterEnumerated<MONTELocationTypeEnum>
{
}