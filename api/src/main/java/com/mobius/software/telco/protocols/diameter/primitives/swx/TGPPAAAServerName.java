 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.TGPP_AAA_SERVER_NAME, vendorId = VendorIDs.TGPP_ID, must = false, name = "3GPP-AAA-Server-Name")
public interface TGPPAAAServerName extends DiameterIdentity
{
}