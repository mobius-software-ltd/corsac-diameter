 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.POLICY_COUNTER_STATUS, vendorId = VendorIDs.TGPP_ID, name = "Policy-Counter-Status")
public interface PolicyCounterStatus extends DiameterUTF8String
{
}