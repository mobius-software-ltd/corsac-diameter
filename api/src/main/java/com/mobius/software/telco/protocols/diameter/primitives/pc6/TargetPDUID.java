 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.TARGET_PDUID, vendorId = VendorIDs.TGPP_ID, must = false, name = "Target-PDUID")
public interface TargetPDUID extends DiameterOctetString
{
}