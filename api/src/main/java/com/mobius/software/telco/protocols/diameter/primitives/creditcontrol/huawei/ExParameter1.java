 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.EX_PARAMETER_1, vendorId = VendorIDs.HUAWEI_ID, name = "Ex-Parameter-1")
public interface ExParameter1 extends DiameterUTF8String
{
}