 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.AREA_TYPE, vendorId = VendorIDs.TGPP_ID, must = false, name = "Area-Type")
public interface AreaType extends DiameterUnsigned32
{
}