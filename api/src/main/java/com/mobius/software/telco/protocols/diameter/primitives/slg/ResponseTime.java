 ...
 * 	7.4.11	Response-Time
	...
	DELAY_TOLERANT (1)
 */
@DiameterAvpDefinition(code = 2509L, vendorId = KnownVendorIDs.TGPP_ID, name = "Response-Time")
public interface ResponseTime extends DiameterEnumerated<ResponseTimeEnum>
{
}