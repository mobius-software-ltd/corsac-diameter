 ...
 */
@DiameterAvpDefinition(code = HuaweiAvpCodes.EX_PARAMETER_7, vendorId = VendorIDs.HUAWEI_ID, name = "Ex-Parameter-7")
public interface ExParameter7 extends DiameterUTF8String
{
}