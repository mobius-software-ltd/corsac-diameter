 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MAXIMUM_FLOW_BITRATES, vendorId = VendorIDs.TGPP_ID, must = false, name = "Maximum-Flow-Bitrates")
public interface MaximumFlowBitrates extends DiameterInteger32
{
}