 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.DEFERRED_LOCATION_REPORTING_DATA, vendorId = VendorIDs.TGPP_ID, must = false, name = "Delayed-Location-Reporting-Data")
public interface DelayedLocationReportingData extends DiameterGroupedAvp
{
