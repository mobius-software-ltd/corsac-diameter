...
/*
	...
	The UAR-Flags AVP is of type Unsigned32 and it contains a bit mask. The meaning of the bits is defined in the following 
	table:
	Table 6.3.44.1: UAR-Flags
	Bit Name
	Description

	0 IMS Emergency Registration
 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.UAR_FLAGS, vendorId = VendorIDs.TGPP_ID, must = false, name = "UAR-Flags")
