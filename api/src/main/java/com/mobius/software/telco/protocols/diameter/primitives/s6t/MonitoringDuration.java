 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MONITORING_DURATION, vendorId = VendorIDs.TGPP_ID, name = "Monitoring-Duration")
public interface MonitoringDuration extends DiameterTime
{
}