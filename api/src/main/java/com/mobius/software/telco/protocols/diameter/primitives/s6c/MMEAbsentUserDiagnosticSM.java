 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MME_ABSENT_USER_DIAGNOSTIC_SM, vendorId = VendorIDs.TGPP_ID, name = "MME-Absent-User-Diagnostic-SM")
public interface MMEAbsentUserDiagnosticSM extends DiameterUnsigned32
{
}