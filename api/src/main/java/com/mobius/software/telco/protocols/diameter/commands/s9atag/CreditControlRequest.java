 ...
 * 	A.8.6.2	CC-Request (CCR) Command
	...
	<CC-Request> ::= < Diameter Header: 272, REQ, PXY >
               ...
               *[ AVP ]
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.S9ATAG, commandCode = CommandCodes.CREDIT_CONTROL, request = true, proxyable = true, name="Credit-Control-Request")
