 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.IPCAN_TYPE, vendorId = VendorIDs.TGPP_ID, name = "IP-CAN-Type")
public interface IPCANType extends DiameterEnumerated<IPCANTypeEnum>
{
}