 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.OSA_APP_ID, vendorId = VendorIDs.TGPP_ID, must = false, name = "OS-App-ID")
public interface OSAppID extends DiameterUTF8String
{
}