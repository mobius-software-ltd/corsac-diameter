 ...
 * 	Insert-Subscriber-Data-Answer (IDA) Command
	...
	< Insert-Subscriber-Data-Answer> ::=	< Diameter Header: 319, PXY, 16777308 >
					...
					*[ Route-Record ]
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.S7A, commandCode = CommandCodes.INSERT_SUBSCRIBER_DATA, request = false, proxyable = true, name="Insert-Subscriber-Data-Answer")
