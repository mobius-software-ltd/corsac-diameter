 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.ABSENT_USER_DIAGNOSTIC_SM, vendorId = VendorIDs.TGPP_ID, name = "Absent-User-Diagnostic-SM")
public interface AbsentUserDiagnosticSM extends DiameterUnsigned32
{
}