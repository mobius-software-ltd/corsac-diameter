 ...
 * 	5.5.8	Trigger-Establishment-Answer (TEA) Command
	The TEA command, indicated by the Command-Code field set to 8388656 and the 'R' bit cleared in the Command Flags field, is sent by the V-PCRF to the H-PCRF in response to the TER command.
	Message Format:
...
public interface TriggerEstablishmentAnswer extends com.mobius.software.telco.protocols.diameter.commands.commons.AuthenticationAnswer
{
	...
	DRADeploymentEnum getDRADeployment();
	
	void setDRADeployment(DRADeploymentEnum value);	
