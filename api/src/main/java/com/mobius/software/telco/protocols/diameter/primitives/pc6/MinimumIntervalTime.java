 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MINIMUM_INTERNAL_TIME, vendorId = VendorIDs.TGPP_ID, name = "Minimum-Interval-Time")
public interface MinimumIntervalTime extends DiameterUnsigned32
{
}