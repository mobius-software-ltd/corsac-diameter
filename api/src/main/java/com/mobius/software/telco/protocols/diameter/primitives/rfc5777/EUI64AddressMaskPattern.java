 ...
 */
@DiameterAvpDefinition(code = AvpCodes.EUI64_ADDRESS_MASK_PATTERN, vendorId = -1L, name = "EUI64-Address-Mask-Pattern")
public interface EUI64AddressMaskPattern extends DiameterOctetString
{
}