 ...
 * 	6.2.16	ProSe-Alert-Answer (ALA) Command
	...
	< ProSe-Alert-Answer > ::=	< Diameter Header: 8388674, PXY, 16777340 >
			...
			*[ Route-Record ]
 */
@DiameterCommandDefinition(applicationId = ApplicationIDs.PC6, commandCode = CommandCodes.PROSE_ALERT, request = false, proxyable = true, name="ProSe-Alert-Answer")
public interface ProSeAlertAnswer extends Pc6Answer
{
}