 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.UE_PC5_AMBR, vendorId = VendorIDs.TGPP_ID, must = false, name = "UE-PC5-AMBR")
public interface UEPC5AMBR extends DiameterUnsigned32
{
}