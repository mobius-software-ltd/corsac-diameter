 ...
 * 	5.3.13	Specific-Action AVP
	...
	FAILED_QOS_UPDATE (20)
		...
		Applicable to functionality introduced with the MPSforDTS feature as described in clause 5.4.1.
 */
public enum SpecificActionEnum implements IntegerEnum
{
	CHARGING_CORRELATION_EXCHANGE(1),INDICATION_OF_LOSS_OF_BEARER(2),INDICATION_OF_RECOVERY_OF_BEARER(3),INDICATION_OF_RELEASE_OF_BEARER(4),IP_CAN_CHANGE(6),
	INDICATION_OF_OUT_OF_CREDIT(7),INDICATION_OF_SUCCESSFUL_RESOURCES_ALLOCATION(8),INDICATION_OF_FAILED_RESOURCES_ALLOCATION(9),
	INDICATION_OF_LIMITED_PCC_DEPLOYMENT(10),USAGE_REPORT(11),ACCESS_NETWORK_INFO_REPORT(12),INDICATION_OF_RECOVERY_FROM_LIMITED_PCC_DEPLOYMENT(13),
	INDICATION_OF_ACCESS_NETWORK_INFO_REPORTING_FAILURE(14),INDICATION_OF_TRANSFER_POLICY_EXPIRED(15),PLMN_CHANGE(16),EPS_FALLBACK(17),
	INDICATION_OF_REALLOCATION_OF_CREDIT(18),SUCCESSFUL_QOS_UPDATE(19),FAILED_QOS_UPDATE(20);
	
	private static final Map<Integer, SpecificActionEnum> intToTypeMap = new HashMap<Integer, SpecificActionEnum>();
	static
	{
	    for (SpecificActionEnum type : SpecificActionEnum.values()) 
	    {
	    	intToTypeMap.put(type.value, type);
	    }
	}

	public static SpecificActionEnum fromInt(Integer value) 
	{
		SpecificActionEnum type = intToTypeMap.get(value);
	    return type;
	}
	
	private int value;
	
	private SpecificActionEnum(int value)
	{
		this.value=value;
	}
