 ...
 * 	9.2.2.4.2	Abort-Session-Answer (ASA) Command
	...
	< Abort-Session-Answer > ::=	< Diameter Header: 274, PXY, 16777272 >
				...
				*[ AVP ]
 */
@DiameterCommandDefinition(applicationId = 16777272, commandCode = 274, request = false, proxyable = true, name="Abort-Session-Answer")
public interface AbortSessionAnswer extends S6bAnswer
{	
}