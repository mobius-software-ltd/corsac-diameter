 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.UE_SRVCC_CAPABILITY, vendorId = VendorIDs.TGPP_ID, must = false, name = "UE-SRVCC-Capability")
public interface UESRVCCCapability extends DiameterEnumerated<UESRVCCCapabilityEnum>
{
}