 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.RTR_FLAGS, vendorId = VendorIDs.TGPP_ID, must = false, name = "RTR-Flags")
public interface RTRFlags extends DiameterBitmask32
{
	public static final int REFERENCE_LOCATION_INFORMATION_CHANGE_BIT = 0;	
