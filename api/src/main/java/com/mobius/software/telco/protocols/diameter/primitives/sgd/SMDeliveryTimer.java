 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.SM_DELIVERY_TIMER, vendorId = VendorIDs.TGPP_ID, name = "SM-Delivery-Timer")
public interface SMDeliveryTimer extends DiameterUnsigned32
{
}