 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.NUMBER_OF_UES, vendorId = VendorIDs.TGPP_ID, name = "Number-Of-UEs")
public interface NumberOfUEs extends DiameterUnsigned32
{
}