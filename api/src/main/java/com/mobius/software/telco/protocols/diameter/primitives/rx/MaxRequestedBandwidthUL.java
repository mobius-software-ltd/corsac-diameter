 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.MAX_REQUESTED_BANDWIDTH_UL, vendorId = VendorIDs.TGPP_ID, name = "Max-Requested-Bandwidth-UL")
public interface MaxRequestedBandwidthUL extends DiameterUnsigned32
{
}