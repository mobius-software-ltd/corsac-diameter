 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.ROUTING_IP_ADDRESS, vendorId = VendorIDs.TGPP_ID, must = false, name = "Routing-IP-Address")
public interface RoutingIPAddress extends DiameterAddress
{
}