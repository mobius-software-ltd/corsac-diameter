 ...
 */
@DiameterAvpDefinition(code = 1662L, vendorId = KnownVendorIDs.TGPP_ID, must = false, name = "Event-Threshold-Event-1I")
public interface EventThresholdEvent1I extends DiameterInteger32
{
}