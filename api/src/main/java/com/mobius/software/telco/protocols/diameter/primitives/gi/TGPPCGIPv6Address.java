 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.TGPP_CG_IPV6_ADDRESS, vendorId = VendorIDs.TGPP_ID, must = false, name = "3GPP-CG-IPv6-Address")
public interface TGPPCGIPv6Address extends DiameterOctetString
{
}