 ...
 * 	7.2.38A Charge-Reason-Code AVP
	...
	4 ADD-ON-CHARGE 
 */
@DiameterAvpDefinition(code = TgppAvpCodes.CHARGE_REASON_CODE, vendorId = VendorIDs.TGPP_ID, name = "Charge-Reason-Code")
public interface ChargeReasonCode extends DiameterEnumerated<ChargeReasonCodeEnum>
{
}