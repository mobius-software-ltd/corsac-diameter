 ...
 */
public enum EventTriggerEnum implements IntegerEnum
{
	SGSN_CHANGE(0),QOS_CHANGE(1),RAT_CHANGE(2),TFT_CHANGE(3),PLMN_CHANGE(4),LOSS_OF_BEARER(5),RECOVERY_OF_BEARER(6),
	IPCAN_CHANGE(7),QOS_CHANGE_EXCEEDING_AUTHORIZATION(11),RAI_CHANGE(12),USER_LOCATION_CHANGE(13),NO_EVENT_TRIGGERS(14),
	OUT_OF_CREDIT(15),REALLOCATION_OF_CREDIT(16),REVALIDATION_TIMEOUT(17),UE_IP_ADDRESS_ALLOCATE(18),
	UE_IP_ADDRESS_RELEASE(19),DEFAULT_EPS_BEARER_QOS_CHANGE(20),AN_GW_CHANGE(21),SUCCESSFUL_RESOURCE_ALLOCATION(22),
	RESOURCE_MODIFICATION_REQUEST(23),PGW_TRACE_CONTROL(24),UE_TIME_ZONE_CHANGE(25),TAI_CHANGE(26),ECGI_CHANGE(27),
	CHARGING_CORRELATION_EXCHANGE(28),APN_AMBR_MODIFICATION_FAILURE(29),USER_CSG_INFORMATION_CHANGE(30),
	USAGE_REPORT(33),DEFAULT_EPS_BEARER_QOS_MODIFICATION_FAILURE(34),USER_CSG_HYBRID_SUBSCRIBED_INFORMATION_CHANGE(35),
	USER_CSG_HYBRID_UNSUBSCRIBED_INFORMATION_CHANGE(36),ROUTING_RULE_CHANGE(37),APPLICATION_START(39),
	APPLICATION_STOP(40),CS_TO_PS_HANDOVER(42),UE_LOCAL_IP_ADDRESS_CHANGE(43),HENB_LOCAL_IP_ADDRESS_CHANGE(44),
	ACCESS_NETWORK_INFO_REPORT(45),CREDIT_MANAGEMENT_SESSION_FAILURE(46),DEFAULT_QOS_CHANGE(47),
	CHANGE_OF_UE_PRESENCE_IN_PRESENCE_REPORTING_AREA_REPORT(48),ADDITION_OF_ACCESS(49),REMOVAL_OF_ACCESS(50),
	UNAVAILABLITY_OF_ACCESS(51),AVAILABLITY_OF_ACCESS(52),RESOURCE_RELEASE(53),ENODEB_CHANGE(54),
	TGPP_PS_DATA_OFF_CHANGE(55),UE_STATUS_RESUME(56),SUCCESSFUL_QOS_UPDATE(57);

	private static final Map<Integer, EventTriggerEnum> intToTypeMap = new HashMap<Integer, EventTriggerEnum>();
	static
	{
	    for (EventTriggerEnum type : EventTriggerEnum.values()) 
	    {
	    	intToTypeMap.put(type.value, type);
	    }
	}

	public static EventTriggerEnum fromInt(Integer value) 
	{
		EventTriggerEnum type = intToTypeMap.get(value);
	    return type;
	}
	
	private int value;
	
	private EventTriggerEnum(int value)
	{
		this.value=value;
	}
