 ...
 * 	7.1.8 Abort-Session-Answer (ASA) command
	...
	<AS-Answer> ::= < Diameter Header: 274, PXY >
			 ...
			 *[ AVP ] 
 */
@DiameterCommandDefinition(applicationId = 16777222, commandCode = 274, request = false, proxyable = true, name="Abort-Session-Answer")
public interface AbortSessionAnswer extends com.mobius.software.telco.protocols.diameter.commands.gq.AbortSessionAnswer
{	
}