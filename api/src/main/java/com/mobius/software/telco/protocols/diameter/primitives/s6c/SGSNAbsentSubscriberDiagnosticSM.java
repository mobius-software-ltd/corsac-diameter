 ...
 */
@DiameterAvpDefinition(code = TgppAvpCodes.SGSN_ABSENT_USER_DIAGNOSTIC_SM, vendorId = VendorIDs.TGPP_ID, name = "SGSN-Absent-Subscriber-Diagnostic-SM")
public interface SGSNAbsentSubscriberDiagnosticSM extends DiameterUnsigned32
{
}