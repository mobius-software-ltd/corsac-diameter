...
import com.mobius.software.telco.protocols.diameter.app.custom.SessionFactory;
...
public class CustomProviderImpl extends DiameterProviderImpl<ClientListener, ServerListener, AvpFactory, MessageFactory, SessionFactory>
{
	public static Logger logger=LogManager.getLogger(CustomProviderImpl.class);
	
	public CustomProviderImpl(DiameterStack stack,String packageName)
	{
	...
	{		
		try
		{
			if(message instanceof CreditControlRequest)
				return new CustomServerSessionImpl(message.getSessionId(), message.getOriginHost(), message.getOriginRealm(), this);
		}
